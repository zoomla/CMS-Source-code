 ...
 * 创建者默认有管理员权限,但可移除
 */ 
public partial class Plat_Admin_Default : System.Web.UI.Page
{
    ...
    public string GetULink()
    {
        ...
        string ulink = SiteConfig.SiteInfo.SiteUrl + "/User/RegPlat.aspx?Invite=" + code;
        return ulink;
    }
    //激活
