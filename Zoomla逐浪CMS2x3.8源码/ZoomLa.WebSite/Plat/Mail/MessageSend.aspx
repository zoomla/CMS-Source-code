<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MessageSend.aspx.cs" Inherits="ZoomLa.WebSite.User.MessageSend" ValidateRequest="false" ClientIDMode="Static" MasterPageFile="~/Plat/Main.master" %>
