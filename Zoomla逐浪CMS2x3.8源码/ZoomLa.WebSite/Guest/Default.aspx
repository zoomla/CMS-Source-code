<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Guest_Default" MasterPageFile="~/Common/Master/Empty.master" ValidateRequest="false" %>
...
<style type="text/css">
#EGV tr > td {border-right:none;border-left:none;}
#EGV .post_title {margin-left:5px; color:#666;font-size:14px;}
#EGV .post_title:hover {color:#007CD5;}
</style>
