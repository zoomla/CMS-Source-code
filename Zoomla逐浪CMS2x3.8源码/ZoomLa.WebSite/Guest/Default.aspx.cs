...
public partial class Guest_Default : System.Web.UI.Page
{
    ...
    private void MyBind()
    {
        ...
        //-----------------------------
        PageSetting setting = cateBll.SelPage(1, CPage, CateID, -100, -100, Skey);
        RPT.DataSource = setting.dt;
        RPT.DataBind();
        Page_Lit.Text = PageCommon.CreatePageHtml(PageHelper.GetPageCount(setting.itemCount, 10), CPage);
    }
