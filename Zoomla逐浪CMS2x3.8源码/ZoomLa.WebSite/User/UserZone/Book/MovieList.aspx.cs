...
public partial class MovieList : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.WebUserControlLabel1.Allstype = 1;
    ...
    private void GetBooktable(string search)
    {
        int CPage;
        int temppage;
        List<BookTable> list = bbll.GetBookLike(search, 1);
        if (list.Count < 1)
        {
            this.AddBook.Visible = true;
            this.AddBook.Text = "没有记录" + search + " <a href=\"MovieAdd.aspx?BookName=" + search + "\">添加电影" + search + "</a>";
        ...
        else
        {
            ...
            Toppage.Text = "<a href=MovieList.aspx?Currentpage=0>首页</a>";
            Nextpage.Text = "<a href=MovieList.aspx?Currentpage=" + nextpagenum.ToString() + ">上一页</a>";
            Downpage.Text = "<a href=MovieList.aspx?Currentpage=" + downpagenum.ToString() + ">下一页</a>";
            Endpage.Text = "<a href=MovieList.aspx?Currentpage=" + Endpagenum.ToString() + ">尾页</a>";
