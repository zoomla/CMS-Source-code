<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShareList.aspx.cs" Inherits="User_Order_ShareList" MasterPageFile="~/Common/Common.master"%>
							...
							<tr>
							   ...
							   <%-- <em data-tid="8285256" class="item">外观漂亮<b class="num"></b></em>--%>
								...
								<td class="com-i-column column5">
									<div class="user-item"><img src="<%#Eval("UserFace") %>" onerror="shownoface(this);" class="img80" /></div>
									<div class="user-item">
...
.comments-header { border: 1px solid #ddd; padding: 0 20px; background: #f7f7f7; height: 30px; line-height: 30px; }
.sphead { text-align: center; font-weight: 700; display: inline-block; }
.column1 {width:48%;}
.column2 {width:15%;text-align:left;}
.column3 {width:15%;}
.column4 {width:20%;text-align:left;}
/*回复主列表 上右下左*/
...
.comments-item .reply-trigger {cursor:pointer;color:#999;}
