...
<title><asp:Literal ID="Title_L" runat="server" /></title>
<style>body{position:relative;} .note{position:static!important;}</style>
...
<div class="avatar"><a href="javascript:;"><img src="{{item.UserFace}}" onerror="shownoface(this);"/></a></div>
<div class="content">
