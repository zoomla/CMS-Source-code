<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Design_Default" EnableViewState="false" MasterPageFile="~/Common/Master/Empty.master" %>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="javascript:;" onclick="ShowComDiag('/design/ppt/diag/add.aspx','新建PPT');" title="新建PPT"><i class="fa fa-file-powerpoint-o"></i> </a></li>
