...
public partial class Design_User_Default : System.Web.UI.Page
{
    ...
    protected void Scence_RPT_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            case "del2":
                var pageMod = seBll.SelReturnModel(Convert.ToInt32(e.CommandArgument));
                pageMod.Status = (int)ZLEnum.ConStatus.Recycle;
                seBll.UpdateByID(pageMod);
                break;
        }
        MyBind();
    }
