<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Design_ppt_Default" MasterPageFile="~/Common/Master/Empty2.master" %>
...
$(function () {
    ...
    $(".cmd_conf:first").click(function(){CloseDiag();ShowDiag_L("/design/ppt/diag/add.aspx?id=<%:Mid%>", "PPT设置");});
