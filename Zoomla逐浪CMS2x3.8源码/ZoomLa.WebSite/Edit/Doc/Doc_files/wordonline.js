...
function() { ! 
    function() {
        function a() {
            ...
            if (c) {
                ...
                d.href = c,
                d.href = d.href;
                var e = d.protocol + "//" + d.hostname + (d.port && "80" != d.port ? ":" + d.port: ""),
        ...
        window.WO = {
            ...
            WO_ROOT_URL: d,
            WO_SERVER_URL: e,
            uploaderSwfUrl: "/Plugins/Ueditor/third-party/webuploader/Uploader.swf",
            uploaderServerUrl: "/Plugins/Ueditor/net/controller.ashx",
            ...
            getParam: function() {
                ...
                return function(b) {
                    if (!a) {
                        ...
                        e;
                        if (a = {},
                        e = location.hash.substr(1)) for (e = e.split("&"), c = 0; c < e.length; c++) d = e[c].split("="),
                        a[d[0]] = d[1]
                    }
                    return a[b]
                }
        ...
        $.extend(WO, {
            ...
            hideMsg: function() {
                ...
                if (b) {
                    ...
                    var c = 0 === b.indexOf(WO.basePath) ? b.substr(WO.basePath.length) : b,
                    d = "#path=" + c;
                    d != window.location.hash && (window.location.hash = encodeURI(d))
                } else $("#wordonline-filename").html("未命名文档")
            },
            message: function(a) {
    ...
    function() {
        function a(a, b) {
            return void 0 === a ? {
                fid: g,
                path: f
            }: (void 0 !== a && null !== a && (g = a), void 0 !== b && null !== b && (f = b), WO.editor.execCommand("serverparam", {
                fid: g,
                path: f
            }), WO.fire("doccurrentchange"), void 0)
        }
        function b(a) {
        ...
        g = "",
        h = 0,
        i = WO.WO_SERVER_URL + "net/controller.ashx?action=uploadfile",
        j = function(a) {
            try {
        ...
        $.extend(WO, {
            initRequester: function() {
                WO.editor && WO.editor.on("imageUploadSuccess", 
                function(b, c) { ! g && c.fid && a(c.fid, c.path)
                })
            },
            doc: {
                create: function(a, b) {
                ...
                open: function(b, c) {
                    ...
                    function(b) {
                        WO.removeMask();
                        var d = j(b);
                        d && "SUCCESS" == d.state && (d.html || d.bdjson) ? (a(d.fid, d.path), WO.hideMsg()) : WO.updateMsg({
                            timeout: 3e3,
                            content: d && "SUCCESS" == d.state ? "文档没有内容!": "文档打开失败!"
                        }),
                        c && c(d)
                    })
                },
                view: function(c, d) {
                    ...
                    function(c) {
                        WO.removeMask();
                        var e = j(c);
                        e && "SUCCESS" == e.state && (e.html || e.bdjson) ? (a(e.fid, e.path), WO.hideMsg(), b(e.path)) : WO.updateMsg({
                            timeout: 3e3,
                            content: e && "SUCCESS" == e.state ? "文档没有内容!": "文档打开失败!"
                        }),
                        d && d(e)
                    })
                },
                save: function(b, k) {
                    ...
                    $.post(i + "?cmd=savedoc&fid=" + g + "&path=" + f + "&newpath=" + (b.newpath || f) + "&docid=" + c + (e ? "&path=" + d: ""), {
                        content: b.content
                    },
                    function(b) {
                        var c = j(b);
                        c && "SUCCESS" == c.state ? (a(c.fid, c.path), WO.isUnSave = !1, WO.hideMsg()) : (WO.isUnSave = !0, WO.updateMsg({
                            timeout: 3e3,
                            content: "文档保存失败!"
                        }), h = 0),
                        k && k(c)
                ...
                upload: function(a) {
                    ...
                    var b = function(d, e) {
                        ...
                        a.off("uploadSuccess", b),
                        a.off("uploadError error", c)
                    },
                    c = function() {
                        $(document.body).removeClass("loading"),
                        WO.updateMsg({
                    ...
                    a.on("uploadSuccess", b),
                    a.on("uploadError error", c)
                },
                getUploadedDoc: function(c, d) {
                    ...
                    function(c) {
                        ...
                        var e = j(c),
                        f = e.bdjson;
                        e.html ? (a(e.fid, e.path), WO.hideMsg(), d && d(e.html, "html"), b(e.path)) : f && f["document.xml"] && f["document.xml"].length ? (a(e.fid, e.path), WO.hideMsg(), d && d(f["document.xml"], "bdjson"), b(e.filename)) : (WO.updateMsg({
                            timeout: 3e3,
                            content: "文档获取失败!"
                        }), d && d())
                    })
                ...
                download: function() {
                    var a,
                    b = ( + new Date).toString(36),
                    c = f || "未命名文档",
                    d = WO.editor.getContent(),
                    e = $("<iframe>").attr("name", "iframe_" + b).attr("id", "iframe_" + b).hide().appendTo(document.body).on("load", 
                    function() {
                        setTimeout(function() {
                            e.remove(),
                            a.remove()
                    ...
                    a = $('<form action="' + i + '?cmd=downloaddoc" method="post" target="iframe_' + b + '" accept-charset="utf-8"><input type="hidden" name="content" value="" /><input type="hidden" name="filename" value="" /><input type="submit" name="content" value="" /></form>').attr("name", "iframe_" + b).attr("id", "iframe_" + b).hide().appendTo(document.body),
                    a.find("[name=content]").val(d),
                    ...
                    function() {
                        ...
                        } else console && console.log("empty text")
                    }),
                    a.submit()
                },
                current: a
        ...
        $.extend(WO, {
            share: {
                ...
                add: function(b, c) {
                    $.post(i + "?cmd=addshare&fid=" + g + "&path=" + f, {
                        content: b.content
                    },
                    function(b) {
                        var d = j(b);
    ...
    function() {
        WO.initLogin = function() {
            function a(a) {
                ...
                $(document).delegate(".login-button", "click", 
                function() {
                    //fio.user.login({
                    //    remember: 2592e3
                    //})
        ...
        return {
            setup: function(a) {
                ...
                a.off = function(a, c) {
                    var d = b[a];
                    if (d) {
                        var e = d.indexOf(c);~e ? d.splice(e, 1) : c[a] = null
                    }
                    return this
                },
                a.once = function(b, c) {
    ...
    function() {
        ...
        b = function(b, c) {
            ...
            e,
            f = c.keyCode;
            if (91 != f) for (e in a) d = e.match(/(ctrl\+)?(shift\+)?(alt\+)?([\d]+)/),
            !(c.ctrlKey || c.metaKey) ^ Boolean(d[1]) && !c.shiftKey ^ Boolean(d[2]) && !c.altKey ^ Boolean(d[3]) && f == d[4] && WO.fire(a[e], a[e], c)
        };
        WO.on("backspace", 
        function(a, b) {
        ...
        var c = WO.editor;
        c && (c.on("keydown", b), $(document.body).on("keydown", b), UE.browser.chrome && c.on("keydown", 
        function(a, b) {
    ...
    function() {
        ...
        WO.ready(function() {
            var b,
            c; (b = a("tpl")) ? WO.fire("loadtemplate", b) : (c = a("path")) ? WO.fire("opendoc", c, "current") : (action = a("action")) && WO.fire("switchtotpl"),
    ...
    function() {
        function a() {
            ...
            if (!WO._confirmDialog) {
                ...
                function() {
                    ...
                    WO.editor.on("keydown", a)
                }),
                c.on("close", 
                function() {
                    $(document).off("keydown", a),
                    WO.editor.off("keydown", a)
                }),
                $(c.getContentElement()).append('<div class="wo-confirm-message"></div>'),
                c.positionTo(document.body),
                WO._confirmDialog = c
            }
        ...
        function(d) {
            ...
            if (d) {
                d.onOk && (b = d.onOk),
                d.onCancel && (c = d.onCancel),
                f.find(".fui-dialog-caption").html(d.title || ""),
                f.find(".wo-confirm-message").html(d.message || "确定?");
                var g = e.getButtons();
    ...
    WO.registerUI("searchonwenku", 
    function() {
        var a;
        WO.on("searchonwenku", 
        function(b) {
            function c() {
                UE.browser.webkit ? a.transition({
                    x: "-246px"
                },
                300, "in-out") : a.animate({
                    "margin-left": "-246px"
                },
                "linear")
            }
            ...
            a || (a = $('<div class="search-wenku">   到文库搜索：<a class="keywords" target="_blank" href=""></a>   <div class="s-close" id="s-close">x</div></div>'), a.appendTo(document.body)),
            a.find(".keywords").text(b).attr("href", "http://wenku.baidu.com/search?from=wordonline&ie=utf-8&word=" + encodeURI(b)),
            c(),
            setTimeout(function() {
                d()
            },
    ...
    function() {
        ...
        return {
            ...
            commands: {
                upsize: {
                    execCommand: function() {
                        for (var c = parseInt(a.queryCommandValue("fontsize")), d = 0; d < b.length; d++) if (b[d] > c) {
                ...
                downsize: {
                    execCommand: function() {
                        for (var c = parseInt(a.queryCommandValue("fontsize")), d = b.length - 1; d >= 0; d--) if (b[d] < c) {
                            a.execCommand("fontsize", b[d] + "px");
                            break
                        }
                    }
    ...
    UE.Editor.prototype.getActionUrl = function(a) {
        return "uploadimage" == a || "uploadimage" == a ? WO.WO_SERVER_URL + "net/controller.ashx?action=uploadimage" : "uploadscrawl" == a ? WO.WO_SERVER_URL + "net/controller.ashx?action=uploadscrawl" : this._bkGetActionUrl.call(this, a)
    },
    ...
    function() {
        function a(a, b) {
            ...
            p = new FormData,
            q = UE.utils.serializeParam(k.queryCommandValue("serverparam")) || "",
            r = UE.utils.formatUrl(g + ( - 1 == g.indexOf("?") ? "?": "&") + q);
                    ...
                    if (window.FormData && window.FileReader) {
                        var e = function(e) {
                            ...
                            if (f = "paste" == e.type ? b(e) : c(e)) {
                                ...
                                h && h.size > 0 && (a(h, d), g = !0);
                                g && e.preventDefault()
                            }
                        };
                        d.getOpt("enablePasteUpload") !== !1 && UE.dom.domUtils.on(d.body, "paste ", e),
                        d.getOpt("enableDragUpload") !== !1 ? (UE.dom.domUtils.on(d.body, "drop", e), UE.dom.domUtils.on(d.body, "dragover", 
                        function(a) {
                            "Files" == a.dataTransfer.types[0] && a.preventDefault()
                        })) : UE.browser.gecko && UE.dom.domUtils.on(d.body, "drop", 
                        function(a) {
                ...
                function() {
                    function a() {
                        try {
                            ...
                            "SUCCESS" == f.state && f.url ? (g = c.document.getElementById(d), UE.dom.domUtils.removeClasses(g, "loadingclass"), g.setAttribute("src", e), g.setAttribute("_src", e), g.setAttribute("alt", f.original || ""), g.removeAttribute("id"), c.fireEvent("imageUploadSuccess", f)) : b && b(f.state)
                        } catch(j) {
                            b && b(c.getLang("simpleupload.loadError"))
                        }
                        k.reset(),
                        UE.dom.domUtils.un(m, "load", a)
                    }
                    function b(a) {
                        if (d) {
                    ...
                    if (l.value) {
                        ...
                        e = UE.utils.serializeParam(c.queryCommandValue("serverparam")) || "",
                        ...
                        UE.dom.domUtils.on(m, "load", a),
                        k.action = UE.utils.formatUrl(f + ( - 1 == f.indexOf("?") ? "?": "&") + e),
                        k.submit()
                    }
                });
                var n;
    ...
    UE.commands.preview = {
        execCommand: function() {
            ...
            WO.utils.openPostWin(WO.WO_ROOT_URL + "preview.php", {
                ...
                title: b ? b.substring(b.lastIndexOf("/") + 1, b.lastIndexOf(".")) : "未命名文档",
                createTime: a(),
                author: ""
            })
        },
    ...
    UE.plugins.autoheight = function() {
        ...
        if (b.autoHeightEnabled = b.options.autoHeightEnabled !== !1, b.autoHeightEnabled) {
            ...
            function() {
                b.enableAutoHeight();
                var c;
                UE.dom.domUtils.on(UE.browser.ie ? b.body: b.document, UE.browser.webkit ? "dragover": "drop", 
                function() {
                    clearTimeout(c),
    ...
    WO.registerUI("topbar/logo", 
    function() {
        var a = window.DEBUG ? "./src.php" : "./";
    }),
    WO.registerUI("topbar/moreservice", 
    function() {
        function a() {
        ...
        var b,
        c = $("<link>").attr("href", "http://baiduoffice.duapp.com/public/assets/style/moreService.css").attr("rel", "stylesheet");
        $("head").append(c),
        $.getScript("http://baiduoffice.duapp.com/public/widget/moreService.js", a),
        b = $('<div class="wo-moreservice" id="moreservice"></div>')
    }),
    WO.registerUI("topbar/user", 
    function() {
        function a(a) {
            if (a) j.setLabel(a.username),
            j.getIconWidget().setImage(a.smallImage),
            j.show(),
            i.hide(),
            fio.user.fire("login", a);
            else {
                if ( - 1 == window.location.href.indexOf("nocheck")) return c();
                i.show()
            }
            h.hide(),
            f = a
        ...
        function c() {
            i.setLabel(WO.getLang("ui.loggingin")),
            fio.user.login({
        ...
        function e(a) {
            ...
            fio.user.on("logout", function () { a.addClass("login-required") });
        }
        var f,
        g = (WO.getUI("eve"), WO.editor, $('<div class="user-panel right"></div>').appendTo("#header")),
        h = $('<span class="loading-tip"></span>').text(WO.getLang("ui.checklogin")).appendTo(g),
        i = new FUI.Button({
        ...
        k = new FUI.PopupMenu({
            className: "user-menu"
        }).appendTo(document.getElementById("content-wrapper")).positionTo(j),
        l = k.getMenuWidget().show();
        return $.each(["userinfo", "fui-spliter", "switchuser", "logout"], 
        function(a, b) {
            l.appendItem(new FUI.Item({
        ...
        i.on("click", c),
        $("#content-wrapper").delegate(".login-button", "click", c),
        {
            getCurrent: function() {
                return f
    ...
    WO.registerUI("topbar/fastvisit/feedback", 
    function() {
        var a = WO.getUI("topbar/fastvisit"),
        b = a.add("feedback", "right", !0);
        b.on("click", 
        function() {
            WO.utils.openGetWin("http://tieba.baidu.com/f?kw=%E7%99%BE%E5%BA%A6doc")
        })
    }),
    WO.registerUI("topbar/fastvisit/download", 
    function() {
        var a = WO.getUI("topbar/fastvisit"),
        b = a.add("share", "right", !0);
        b.on("click", 
        function() {
            WO.fire("sharedoc")
        })
    }),
    WO.registerUI("topbar/fastvisit/new", 
    function() {
        var a = WO.getUI("topbar/fastvisit"),
        b = a.add("new", "right", !0);
        b.on("click", 
    ...
    function() {
        var a = WO.getUI("topbar/fastvisit"),
        b = a.add("download", "right", !0);
        b.on("click", 
        function() {
            WO.fire("exportdoc")
        })
    }),
    WO.registerUI("topbar/fastvisit/upload", 
    function() {
        var a = WO.getUI("topbar/fastvisit"),
        b = a.add("upload", "right", !0),
        c = "upload-btn-" + +(new Date).toString(36);
        if ($(b.getElement()).attr("id", c), WO.on("needflash", 
        function() {
            WO.fire("confirm", {
                title: "提示",
            ...
            d.on("uploadBeforeSend", 
            function(a, b) {
                b._COOKIE = document.cookie
            }),
            WO.webuploader = d
        } else $(b.getElement()).on("click", 
        function() {
            WO.fire("needflash")
        })
    }),
    ...
    function() {
        WO.ConfigTraveller = function(a, b) {
            if (a) {
                ...
                if (c && c.length) for (var d = 0; d < c.length; d++) WO.ConfigTraveller(c[d], b)
            }
        },
    ...
    function() {
        function a(a, b, c) {
            var d = a._cmd;
            if (a._dialog) {
                var e = WO.WO_URL + "dialogs/",
                f = a._dialog,
                g = "wo_" + ( + new Date).toString(36),
                h = new FUI.Dialog(f),
                i = $(h.getBodyElement()),
                j = $EDITORUI[g] = {
                    _ishidden: !0,
                    editor: c,
                    className: "wo-dialog-" + d,
                    uiName: "dialog",
                    onok: function() {},
                    onclose: function() {},
                    oncancel: function() {},
        ...
        function b(a, b, c) {
            ...
            if (a._popup) {
                ...
                g = "wo_" + ( + new Date).toString(36),
                h = new FUI.Popup(f),
                i = $(h.getElement()).find(".fui-panel-content"),
                j = $EDITORUI[g] = {
                    _ishidden: !0,
                    editor: c,
                    className: "wo-dialog-" + d,
        ...
        function(f, g, h) {
            ...
            } else f._dialog || f._popup || g.on("click", 
            function() {
                h.execCommand(i)
            });
            return h.on("selectionchange", 
            function() {
    ...
    function(a, b, c) {
        ...
        function e(c) {
            "fontfamily" == g && $.each(a.menu.items, 
            function(a, b) {
        ...
        return "fontfamily" == g && $(".fui-input", b.getElement()).attr({
            readonly: "readonly",
            unselectable: "on"
        }),
    ...
    function(a, b, c) {
        ...
        g.on("click", 
        function() {
            var a; (a = g.getValue()) && c.execCommand(d, a),
            b.close()
        }),
        b
    }),
    ...
    function() {
        function a() {
            ...
            var g,
            h = b.execCommand("getsections"),
            i = "";
            d(h) ? (g = a(h), i = c(g) || e) : i = e,
            $(".section-tree", f).html(i)
        }
        var b = WO.editor,
        c = function(a) {
            var b = [];
        ...
        b.on("aftersetcontent contentchange", 
        function() {
            var c = b.getContent();
            c != d && (d = c, a())
        }),
        f.delegate(".dir-item", "click", 
        function() {
            var a = $(".main"),
            c = $("li").index(this),
            d = $(b.iframe),
        ...
        b.on("toggledirectory", 
        function() {
            $(".dir").toggle()
        }),
        f.delegate(".s-close", "click", 
        function() {
            $(".dir").fadeOut()
        })
    }),
    ...
    function() {
        function a(a, b, c, d) {
            ...
            d.appendWidget(e),
            d.appendWidget(f);
            var g = new FUI.Button({
                className: "wo-filetab-back",
                label: "回退"
            });
            e.appendWidget(g),
            $(f.getContentElement()).before('<div class="wo-filetab-right-title"></div>'),
            g.on("click", 
            function() {
                d.close()
            });
        ...
        function b(b, c, d) {
            ...
            h = $(g.getElement());
            return h.find(".fui-panel-content").addClass("wo-filetab-wrap"),
            g.appendTo(document.body),
            g.positionTo(f.$toolbar[0], "left-top"),
            g._bkopen = g.open,
            g._bkclose = g.close,
            g.open = function() {
                h.css({
            ...
            g.close = function() {
                ...
                300, "linear"),
                h.find(".wo-filetab-right").animate({
                    "margin-left": "-150px"
                },
                300, "linear")
            },
            ...
            WO.ready(function() {
                $("#fileopen,#openfromwangpan,#filesave,#savetowangpan").on("click", 
                function() {
                    e()
                })
            }),
        ...
        WO.initMenu = function () {
            var a = WO.toolbar;
            a.menuButton = new FUI.Button({
                label: "文件",
                className: "wo-btn wo-btn-filetab"
            }),
            a.$tabList.prepend(a.menuButton.getElement()),
            b.call(a, {},
            a.menuButton, a.editor),
            WO.ConfigTraveller(WO.MenuConfig, 
            function(b) {
                var d = c[b._name],
                e = FUI.widgets[b.id];
    ...
    function() {
        ...
        function(a) {
            var b;
            for (b = 0; b < a.buttons.length; b++) a.buttons[b].className = "wo-filetab-button wo-filetab-" + a.buttons[b].id;
           // for (b = 0; b < a.panels.length; b++) a.panels[b].className = "wo-filetab-content wo-filetab-" + a.panels[b].id
        } (WO.MenuConfig)
    } (),
    WO.registerUI("widget/netdiskfinder", 
    function() {
        function a(a, c) {
            function d() {
                function a() {
                ...
                if (d.onprogress) return d.onprogress.select();
                var b = $("<li>").addClass("netdisk-file-list-item dir").prependTo(s),
                c = $("<input>").attr("type", "text").addClass("new-dir-name fui-widget fui-selectable").val(WO.getLang("ui.newdir")).appendTo(b);
                d.onprogress = c[0],
                c[0].select(),
                c[0].focus(),
                c.on("keydown", 
                function(c) {
                    13 == c.keyCode && a(),
                    27 == c.keyCode && (b.remove(), d.onprogress = !1, c.stopPropagation())
                })
            }
            function e(a) {
            ...
            function i(a) {
                ...
                c = g( - 100 * e(a.length - q.length));
                return q = "/" == a.charAt(a.length - 1) ? a: a + "/",
                k(),
                Promise.all([b, c]).then(j, 
                function() {})
            }
            function j(a) {
                s.empty();
                ...
                b.length ? $.each(b, 
                function(a, b) { (b.isDir || c && c(b)) && $("<li></li>").text(b.filename).addClass("netdisk-file-list-item").addClass(b.isDir ? "dir": "file").data("file", b).appendTo(s)
                }) : s.append('<li class="empty" disabled="disabled">' + WO.getLang("ui.emptydir") + "</li>"),
                h(),
                m(),
                o.fire("cd", q, a[0])
            }
            function k() {
                function a(a) {
                    d += a + "/";
                    var b = $("<a></a>");
                    return b.text(a == p ? WO.getLang("ui.mydocument") : a),
                    b.data("path", d)
                }
                r.empty(),
                r.append(q != p && q != p + "/" ? '<a class="dir-back">Back</a>': '<span class="my-document"></span>');
                var b = q.substr(p.length),
                c = b.split("/"),
                d = "";
                r.append(a(p)),
                $.each(c, 
            ...
            p = "/apps/wordonline",
            q = p,
            r = $('<div class="netdisk-nav"></div>').appendTo(a),
            s = $('<ul class="netdisk-file-list"></ul>').appendTo(a),
            t = ($("<a></a>").text(WO.getLang("ui.mkdir")).addClass("button netdisk-mkdir").click(d), $("<a></a>").text(WO.getLang("ui.mkdir")).addClass("button netdisk-mkdir").click(d)),
            u = null;
            return r.after(t),
            a.addClass("netdisk-finder-container"),
            s.delegate(".netdisk-file-list-item", "click", 
            function(a) {
                if (d.onprogress) return d.onprogress.select();
                var b = $(a.target),
                c = b.data("file");
    ...
    WO.registerWouiHandler("filenew", 
    function(a, b, c) {
        function d(a) {
            function b(b) {
                clearTimeout(d);
            ...
            if (i) a(1 == i);
                ...
                300),
                e.src = g + "favicon.ico?v=" + +new Date
            }
        }
        function e(a, b) {
            if (a || a.length) {
                var c,
                d = ['<div class="tpl-list">'];
                $.each(a, 
                function(a, e) {
                    d.push('<h2 class="filenew-title">' + e.name + '</h2><div class="filenew-main"><ul class="tpl-list">'),
                    $.each(e.list, 
                    function(a, e) {
                        c = (b || WO.WO_URL) + "images/" + e.id + ".png",
                        d.push('<li class="tpl-item" data-title="' + e.title + '" data-id="' + e.id + '"><div class="tpl-thumbnails">' + (e.thumbs ? e.thumbs: '<img src="' + c + '" />') + '</div><div class="tpl-title">' + e.title + "</div></li>")
                    }),
                    d.push('<li class="tpl-item tpl-add" data-title="贡献模板" data-id="blank">   <div class="tpl-thumbnails" style="border-style:dashed;">       <p style="color: #CCC;font-size: 36px;text-align: center;margin-top: 40px;">+</p>   </div>   <div class="tpl-title">贡献模板</div></li>'),
                    d.push("</div></ul>")
                }),
                d.push("</div>"),
                f.find(".filenew-content").html(d.join(""))
            }
        }
        var f = $(b.getElement()),
        g = "http://wordonline.newoffline.bae.baidu.com/static/tpl/",
        h = WO.WO_URL + "tpl/";
        ...
        function() {
            ...
            }) : (WO.menu.isOpen() && WO.menu.close(), WO.utils.openGetWin("#tpl=" + $(this).attr("data-id")))
        }),
        WO.on("newdoc", 
        function(a) {
    ...
    WO.registerWouiHandler("fileopen", 
    function(a, b, c) {
       
    }),
    WO.registerWouiHandler("filesave", 
    function(a, b, c) {
        function d(a) {
            WO.menu.close(),
            e(c.getContent(), a)
        ...
        h.find(".filesave-subtab").on("click", 
        function() {
            var a = $(this),
            b = $("#" + a.attr("id") + "-content");
            $(".filesave-subtab").not(a).removeClass("filesave-active"),
            a.addClass("filesave-active"),
            $(".filesave-subpanel").not(b).removeClass("filesave-active"),
        ...
        h.find(".filesave-local-button .download-button").on("click", 
        function() {
            WO.doc.download()
        }),
        WO.on("exportdoc", 
        ...
        var i = [],
        j = "/apps/wordonline",
        k = $(".filesave-wangpan", h),
        l = WO.getUI("widget/netdiskfinder"),
        m = l.generate($(".filesave-wangpan .netdisk-wrap", h).html(""), 
        function(a) {
        ...
        var p,
        q;
        return WO.isUnSave = !1,
        WO.on("savedoc saveasdoc", 
        function(a, b) {
            if (b && b.preventDefault(), WO.doc.current().path && "savedoc" == a) {
                WO.menu.isOpen() || WO.menu.close();
                var d = c.getContent();
                if (q == d) return void WO.showMsg({
                    content: "文档已保存",
                    timeout: 2e3
                });
                e(d)
            } else WO.menu.isOpen() || WO.menu.open(),
        ...
        function() {
            var a,
            b = WO.doc.current().path;
            if (b) {
                if (a = c.getContent(), q == a) return;
                var d = f();
    ...
    WO.registerWouiHandler("fileshare", 
    function(a, b, c) {
        function d() {
            var a = [],
            b = $(".share-list-wrap");
            WO.share.list(function(c) {
                ...
                }), b.html(a.join("")), $(".share-tip").hide()) : $(".share-tip").show(),
                e()
            })
        }
        function e() {
        ...
        function f(a) {
            if ("none" !== q) {
                ...
                function() {
                    m.find(".panel-right").removeClass("loading"),
                    b.hide(),
                    q = "none"
                })
            }
        ...
        function i() {
            $(this).hasClass("wo-disabled") || (m.find(".panel-right").addClass("loading"), WO.share.add({
        ...
        function j(a) {
            ...
            var d = window._bd_share_config.common,
            e = window._bd_share_main.init,
            f = a.path ? a.path.substring(a.path.lastIndexOf("/"), a.path.lastIndexOf(".")) : "未命名文档";
            d && e && (d.bdTitle = f, d.bdDesc = d.bdText = f + "- 我用「百度Doc」编辑的文档，快看看吧！", d.bdUrl = c, e && e()),
            b.show(),
        ...
        function l() {
            r.text("已复制").attr("disabled", "disabled"),
            $("#share-url").focus()[0].select(),
            setTimeout(function() {
        ...
        function() {
            ...
            "share-list" == a.attr("id") && d()
        }),
        m.find(".share-list-wrap").delegate(".share-delete", "click", 
        function() {
            var a = $(this);
            a.parents(".share-list-item").slideUp(),
            WO.share.rm({
                id: a.attr("data-sid")
            },
            function() {})
        }),
        m.find(".share-current-button").on("click", 
        function() {
            $(this).hasClass("wo-disabled") || (m.find(".share-current-loding").addClass("loading"), WO.share.add({
                content: WO.editor.getContent()
            },
            function(a) {
                if (m.find(".share-current-button").hide(), m.find(".share-current-loding").removeClass("loading").css("display", "inline-block"), m.find(".share-current-qrcode .share-current-bdshare").slideDown(), a) {
                    var b = location.href.replace(/\/[#\?].*$/, "/").replace(/\/[^/] * $ / ,
                    "/") + "share.php?id=" + a.sid;
            ...
            d(),
            m.find(".share-current-button").removeClass("wo-disabled"),
            m.find(".share-current-body").show(),
            m.find(".share-current-tip").hide()
        }), WO.on("sharedoc", 
        function(a, b) {
            b && b.preventDefault(),
        ...
        var o = bdShareJsLoading = !1, p = "", q = "none"; m.delegate("input[name=sharetype]", "click", 
        function(a) {
            var b = {
                none: f,
                "public": g
        ...
        return UE.browser.ie ? $("#copy-share-url").on("click", 
        function() {
        ...
        function() {
            var a = new ZeroClipboard(document.getElementById("copy-share-url"), {
                hoverClass: "hover",
                activeClass: "active"
            });
            a.on("ready", 
    ...
    WO.registerWouiHandler("fileprint", 
    function() {
        WO.on("print", 
        function(a, b) {
    ...
    WO.registerWouiHandler("filehelp", 
    function(a, b) {
        function c(a) {
            var b,
            c,
            ...
            f = "",
            g = !0;
            return e += '<div class="help-container">',
            e += '<h2 class="help-header">帮助</h2>',
            e += '<div class="help-article row">',
            $.each(a.split("\n"), 
            function(a, h) {
                if (f = "", /^##/g.test(h)) {
                    g ? g = !1: f += "</table>";
                ...
                } else / \S / .test(h) && (f += '<tr class="shortcuts-tbody"><td class="shortcuts-group"><div class="shortcuts-keys right">', b = h.split(":"), c = b[0], d = b[1], c = c.replace(/\`(.+?)\`/g, '<span class="shortcuts-key label">$1</span>'), f += c, f += '</div></td><td class="shortcuts-desc">' + d + "</td>", f += "</tr>");
                e += f
            }),
            e += "<table>",
            e += "</div>",
    ...
    function() {
        function a(a) {
            ...
            return $.each(a, 
            function(a, c) {
                var d; (d = c.baseStyle.p) && $.each($.isArray(d) ? d: [d], 
                function(a, d) {
                    $.each(c.style[d], 
                    function(a, c) {
                        b[a] = c
                ...
                (d = c.baseStyle.span) && $.each($.isArray(d) ? d: [d], 
                function(a, d) {
                    $.each(c.style[d], 
                    function(a, c) {
                        b[a] = c
        ...
        var b = {
            setWkContent: function(b) {
                ...
                e,
                f = this;
                UE.utils.cssRule("bdjsonBaseStyle", a(b), f.document),
                f.fireEvent("beforesetwkcontent", b),
                c = UE.parseDoc(b),
                d = c.node,
                f.filterWkInputRule(d),
                e = d.toHtml(),
                f.setContent(e),
                f.fireEvent("aftersetwkcontent", e)
            },
            ...
            filterWkInputRule: function(a) {
                ...
                b.wkInputRules && a.traversal(function(a) {
                    for (var c, d = 0; c = b.wkInputRules[d++];) c.call(b, a)
                })
            }
        };
    ...
    UE.plugins.docparserfilters = function() {
        ...
        function c(a) {
            var b = a.getAttr("style");
            b && a.setAttr("style", b.replace(/styleName\s*:\s*([^;]+);/gi, 
            function(b, c) {
                switch (c) {
                case "quote":
        ...
        function f(a) {
            ...
            function c(a, c) {
                ...
                e = c.attrs;
                if (b(d) != b(e)) return ! 1;
                for (var f in d) if (e[f].replace(/;$/, "") !== d[f].replace(/;$/, "")) return ! 1;
                return ! 0
            }
            if ("span" == a.tagName) for (; (next = a.nextSibling()) && c(next, a);) {
                for (; next.firstChild();) a.appendChild(next.firstChild());
                next.parentNode.removeChild(next)
            }
        }
        function g(a) {
            if ("span" == a.tagName && (style = a.getAttr("style"))) {
                if (/valign\s*:\s*(sup|sub);?/i.test(style)) return a.tagName = RegExp.$1,
                void a.setAttr("style", style.replace(/valign\s*:\s*(sup|sub);?/i, ""));
                if (/font-style\s*:\s*italic;?/i.test(style)) return a.tagName = "em",
                void a.setAttr("style", style.replace(/font-style\s*:\s*italic;?/i, ""));
                if (/font-weight\s*:\s*(\d+);?/i.test(style) && 1 * RegExp.$1 >= 700) return a.tagName = "strong",
                void a.setAttr("style", style.replace(/font-weight\s*:\s*(\d+);?/i, ""))
            }
        }
        var h = this,
        i = UE.utils;
    ...
    function() {
        function a(a) {
            ...
            l = null;
            if (!b(c)) {
                if (h) throw new Error("Illegal tag, tag name is: " + c);
                return null
            }
            if (l = new f({
                type: "element",
                children: [],
                tagName: c
            }), d && l.setAttr("class", g.isArray(d) ? d.join(" ") : d), e(l, a), i) if (g.isArray(i)) $.each(i, 
            function(a, b) {
                var c = k(b);
                c && l.appendChild(c)
            });
            else if (g.isString(i)) l.appendChild(new f({
                type: "text",
                data: g.unhtml(i || "")
            }));
            else {
                if (!g.isObject(i)) throw new Error("unkonw child type");
                var m = k(i);
                m && l.appendChild(m)
            }
            return l
        ...
        function c(a, b, d) {
            ...
            if (e = a.getAttr("class"), e = e ? g.trim(e).split(/\s+/) : [], e && e.length) {
                ...
                h = (k.join(";") + ";").replace(/(^;)/, "").replace(/;{2,}/g, ";"),
                i = (l.join(";") + ";").replace(/(^;)/, "").replace(/;{2,}/g, ";"),
                (h || i) && a.setAttr("style", h + i),
                j.length ? a.setAttr("class", j.join(" ")) : a.setAttr("class")
            }
            if ("element" == a.type) for (f = 0; f < a.children.length; f++) c(a.children[f], b, d)
        }
        function d(a) {
            var b = {};
            return g.each(a, 
            function(a, c) {
                var d = [];
                g.each(a, 
                function(a, b) { / [\d\.] + px / .test(a) && (a = a.replace(/[\d]+\.[\d]*px/g, 
                    function(a) {
        ...
        UE.parseDoc = function(b) {
            ...
            if (b) {
                ...
                for (var k = 0; k < b.length; k++) e = a(b[k]),
                c(e, d(b[k].style), b[k].baseStyle),
                h.appendChild(e),
                i.push(e.toHtml());
                j = i.join("")
            } else alert("文档解析出错");
