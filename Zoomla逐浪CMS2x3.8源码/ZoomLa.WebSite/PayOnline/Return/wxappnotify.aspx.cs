...
using ZoomLa.Model;
public partial class PayOnline_Return_wxappnotify : System.Web.UI.Page
{
    ...
    public WxPayData OrderQuery(WxPayData inputObj, int timeOut = 6)
    {
        ...
        inputObj.SetValue("appid", PlatConfig.WXPay_APPID);//公众帐号ID
        inputObj.SetValue("mch_id", PlatConfig.WXPay_MCHID);//商户号
