...
public partial class MIS_OA_Flow_ApplyList : System.Web.UI.Page
{
    ...
    {
        string editTlp = "<a href='/Mis/OA/Flow/FlowApply.aspx?Appid=" + Eval("ID") + "' >修改</a>";
        string delTlp = "<a href='javascript:;' onclick='SetDel("+Eval("ID")+");' style='margin-left:5px;'>删除</a>";
        string dealTlp = "<a href='/Mis/OA/FreeFlow/FlowAudit.aspx?Appid=" + Eval("ID") + "' style='margin-left:5px;'>办理</a>";
        string viewTlp = "<a href='/Mis/OA/FreeFlow/FlowAudit.aspx?Appid=" + Eval("ID") + "&action=view' style='margin-left:5px;'>查看</a>";
    ...
    protected void EGV_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e != null && e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Attributes.Add("ondblclick", "location='/Mis/OA/FreeFlow/FlowAudit.aspx?Appid=" + appid + "';");
            e.Row.ToolTip = "双击查看";
        }
    }
