 ...
 */
public partial class MIS_ZLOA_AffairDrafting : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (!purBll.Auth("OAWorkManage", buser.GetLogin().UserRole)) { function.WriteErrMsg("你当前没有起草事务的权限,请联系管理员!!!"); }
            TypeDataBind();
            DPDataBind();
            #region 签章初始化
