<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserExp.aspx.cs" Inherits="ZoomLa.WebSite.Manage.User.UserExp" EnableViewStateMac="false" MasterPageFile="~/Manage/I/Default.master" %>
