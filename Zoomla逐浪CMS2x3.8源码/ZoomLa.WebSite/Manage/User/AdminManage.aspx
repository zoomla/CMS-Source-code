<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminManage.aspx.cs" Inherits="ZoomLaManage.WebSite.Manage.User.AdminManage" Title="管理员管理" TraceMode="SortByCategory" EnableViewStateMac="false"  MasterPageFile="~/Manage/I/Default.master" %>
