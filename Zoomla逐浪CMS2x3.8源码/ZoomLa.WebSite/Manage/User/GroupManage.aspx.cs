namespace ZoomLa.WebSite.Manage.User
{
    ...
    public partial class GroupManage : CustomerPageAction
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Call.SetBreadCrumb(Master, "<li><a href='" + CustomerPageAction.customPath2 + "I/Main.aspx'>" + Resources.L.工作台 + "</a></li><li><a href='UserManage.aspx'>" + Resources.L.用户管理 + "</a></li> <li class='active'>" + Resources.L.会员组管理 + "<a href=\"Group.aspx\">[" + Resources.L.添加会员组 + "]</a></li>" + Call.GetHelp(38));
        }
    }
}