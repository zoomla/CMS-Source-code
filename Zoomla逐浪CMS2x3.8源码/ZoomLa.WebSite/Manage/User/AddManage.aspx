<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddManage.aspx.cs" Inherits="ZoomLaManage.WebSite.Manage.User.AddManage" EnableViewStateMac="false" MasterPageFile="~/Manage/I/Default.master" ValidateRequest="false" %>
