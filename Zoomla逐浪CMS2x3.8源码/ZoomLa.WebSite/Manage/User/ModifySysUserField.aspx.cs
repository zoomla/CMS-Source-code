...
public partial class manage_User_ModifySysUserField : CustomerPageAction
{
    private B_UserBaseField bll = new B_UserBaseField();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!this.Page.IsPostBack)
        {
            ...
            M_UserBaseField field = this.bll.GetSelect(FieldID);
        ...
        Call.SetBreadCrumb(Master, "<li>后台管理</li><li>用户管理</li><li>会员模型</li><li><a href='SystemUserModel.aspx'>系统会员模型字段列表</a></li><li>修改系统会员模型字段</li>");
    }
    private void GetShow(M_UserBaseField field)
    {
        ...
        switch (type)
        {
            ...
            case "ColorType":
                ...
                break;
            case "TableField":
                TableField_Text.Text = content.Split(',')[0];
                if (content.Split(',').Length > 1)
                    TableField_Value.Text = content.Split(',')[1];
                if (content.Split(',').Length > 2)
                    Where_Text.Text = content.Split(',')[2];
                Page.ClientScript.RegisterStartupScript(this.GetType(), "DisDiv", "SelectModelType();", true);
                break;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        switch (selectedValue)
        {
            ...
            //多图片
            case "MultiPicType":
                str7 = "ChkThumb=" + (this.ChkThumb.Checked ? "1" : "0") + ",ThumbField=" + this.TxtThumb.Text + ",Warter=" + this.RBLPicWaterMark.SelectedValue + ",MaxPicSize=" + this.TxtPicSize.Text + ",PicFileExt=" + this.TextImageType.Text;
                flag2 = false;
                break;
            //文件
            case "SmallFileType":
        ...
        M_UserBaseField tempdata = this.bll.GetSelect(FieldID);
    ...
    private void GetIsOk()
    {
        ...
        if (text == "")
        {
            function.WriteErrMsg(string.Concat(new object[] { "<li>字段名不能为空</li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='ModifySysUserField?FieldID=", this.HdfFieldID.Value, "'>重新添加字段</a> <a href='SystemUserModel.aspx'>返回字段列表</a> </li>" }));
        }
        if (!DataValidator.IsValidUserName(text))
        {
            function.WriteErrMsg(string.Concat(new object[] { "<li>字段名必须由字母、数字、下划线组成</li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='ModifySysUserField?FieldID=", this.HdfFieldID.Value, "'>重新添加字段</a> <a href='SystemUserModel.aspx'>返回字段列表</a> </li>" }));
        }
        if (str2 == "")
        {
            function.WriteErrMsg(string.Concat(new object[] { "<li>字段别名不能为空</li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='ModifySysUserField?FieldID=", this.HdfFieldID.Value, "'>重新添加字段</a> <a href='SystemUserModel.aspx'>返回字段列表</a> </li>" }));
        }
        switch (selectedValue)
        {
            case "TextType":
                ...
                {
                    function.WriteErrMsg(string.Concat(new object[] { "<li>文本框长度不能为空</li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='ModifySysUserField?FieldID=", this.HdfFieldID.Value, "'>重新添加字段</a> <a href='SystemUserModel.aspx'>返回字段列表</a> </li>" }));
                }
                if (!DataValidator.IsNumber(this.TitleSize.Text))
                {
                    function.WriteErrMsg(string.Concat(new object[] { "<li>文本框长度必须是整形数字</li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='ModifySysUserField?FieldID=", this.HdfFieldID.Value, "'>重新添加字段</a> <a href='SystemUserModel.aspx'>返回字段列表</a> </li>" }));
                }
                break;
            ...
            case "MultipleTextType":
                ...
                {
                    function.WriteErrMsg(string.Concat(new object[] { "<li>文本框显示的宽度不能为空</li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='ModifySysUserField?FieldID=", this.HdfFieldID.Value, "'>重新添加字段</a> <a href='SystemUserModel.aspx'>返回字段列表</a> </li>" }));
                }
                if (!DataValidator.IsNumber(this.MultipleTextType_Width.Text))
                {
                    function.WriteErrMsg(string.Concat(new object[] { "<li>文本框显示的宽度必须是整形数字</li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='ModifySysUserField?FieldID=", this.HdfFieldID.Value, "'>重新添加字段</a> <a href='SystemUserModel.aspx'>返回字段列表</a> </li>" }));
                }
                if (this.MultipleTextType_Height.Text == "")
                {
                    function.WriteErrMsg(string.Concat(new object[] { "<li>文本框显示的高度不能为空</li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='ModifySysUserField?FieldID=", this.HdfFieldID.Value, "'>重新添加字段</a> <a href='SystemUserModel.aspx'>返回字段列表</a> </li>" }));
                }
                if (!DataValidator.IsNumber(this.MultipleTextType_Height.Text))
                {
                    function.WriteErrMsg(string.Concat(new object[] { "<li>文本框显示的高度必须是整形数字</li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='ModifySysUserField?FieldID=", this.HdfFieldID.Value, "'>重新添加字段</a> <a href='SystemUserModel.aspx'>返回字段列表</a> </li>" }));
                }
                break;
        ...
        {
            function.WriteErrMsg(string.Concat(new object[] { "<li>单选项的选项不能为空</li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='ModifySysUserField?FieldID=", this.HdfFieldID.Value, "'>重新添加字段</a> <a href='SystemUserModel.aspx'>返回字段列表</a> </li>" }));
        }
        if ((selectedValue == "ListBoxType") && (this.ListBoxType_Content.Text == ""))
        {
            function.WriteErrMsg(string.Concat(new object[] { "<li>多选项的选项不能为空</li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='ModifySysUserField?FieldID=", this.HdfFieldID.Value, "'>重新添加字段</a> <a href='SystemUserModel.aspx'>返回字段列表</a> </li>" }));
        }
        if (selectedValue == "NumType")
        {
            if (this.NumberType_TitleSize.Text == "")
            {
                function.WriteErrMsg(string.Concat(new object[] { "<li>输入数字的文本框长度不能为空</li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='ModifySysUserField?FieldID=", this.HdfFieldID.Value, "'>重新添加字段</a> <a href='SystemUserModel.aspx'>返回字段列表</a> </li>" }));
            }
            if (!DataValidator.IsNumber(this.NumberType_TitleSize.Text))
            {
                function.WriteErrMsg(string.Concat(new object[] { "<li>输入数字的文本框长度必须是整形数字</li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='javascript:window.history.back(-1)'>返回</a></li><li><a href='ModifySysUserField?FieldID=", this.HdfFieldID.Value, "'>重新添加字段</a> <a href='SystemUserModel.aspx'>返回字段列表</a> </li>" }));
            }
        }
    }
}