<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepositManage.aspx.cs" Inherits="Manage_User_DepositManage" MasterPageFile="~/Manage/I/Default.master" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <ZL:ExRepeater ID="Deposit_RPT" runat="server" OnItemCommand="Deposit_RPT_ItemCommand" PageSize="10" PagePre="<tr id='page_tr'><td><input type='checkbox' id='chkAll'/></td><td colspan='10' id='page_td'>" PageEnd="</td></tr>">
            <ItemTemplate>
             ...
             <%--   <td><%#Eval("Y_ID") %></td>--%>
                    <td><a href="javascript:;" onclick="ShowUserDiag(<%#Eval("UserID") %>)" title="<%#Eval("UserID") %>"><%#GetUser() %></a><input type="hidden" name="uname_hid" value="<%#Eval("YName") %>" /></td>
                    <td><%#Eval("GroupName") %></td>
                    <td><%#Eval("money","{0:f2}").Replace(',','.') %><input type="hidden" name="price_hid" value="<%#Eval("money") %>" /></td>
