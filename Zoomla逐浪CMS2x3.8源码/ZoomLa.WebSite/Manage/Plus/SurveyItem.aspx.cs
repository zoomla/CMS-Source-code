...
namespace ZoomLa.WebSite.Manage.Plus
{
    ...
    public partial class SurveyItem : CustomerPageAction
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Sid <= 0) { function.WriteErrMsg("缺少问卷投票的ID参数！", "SurveyItemList.aspx"); }
        ...
        protected void Button_Click(object sender, EventArgs e)
        {
            ...
            if (Qid > 0)
            {
                ...
                function.WriteSuccessMsg("问题修改成功", "SurveyItem.aspx?SID=" + Sid + "&Qid=" + Qid);//, "SurveyItemList.aspx?Sid=" + Sid
            }
            else
            {
                qinfo.SurveyID = Sid;
                ...
                function.WriteSuccessMsg("问题添加成功", "SurveyItem.aspx?SID=" + Sid + "&Qid=" + qid );//, "SurveyItemList.aspx?Sid=" + Sid
            }
        }
    }
}