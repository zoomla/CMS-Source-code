<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="Producer.aspx.cs" Inherits="Zoomla.Website.manage.Shop.Producer" MasterPageFile="~/Manage/I/Default.master"%>
