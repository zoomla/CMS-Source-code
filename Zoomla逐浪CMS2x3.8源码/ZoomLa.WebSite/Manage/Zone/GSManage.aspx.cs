...
public partial class manage_Zone_GSManage : CustomerPageAction
{
    #region 调用业务逻辑
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Call.SetBreadCrumb(Master, "<li><a href='" + CustomerPageAction.customPath2 + "Main.aspx'>工作台</a></li><li><a href='" + customPath2 + "User/UserManage.aspx'>会员管理</a></li><li><a href='ZoneManage.aspx'>会员空间管理</a></li><li class='active'>空间族群列表<a href='LogTypeManage.aspx'>[族群类型管理]</a></li>");
    }
    #region 页面调用方法
