...
public partial class manage_Question_AddClass : CustomerPageAction
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Call.SetBreadCrumb(Master, "<li><a href='" + CustomerPageAction.customPath2 + "I/Main.aspx'>工作台</a></li> <li><a href='Papers_System_Manage.aspx'>教育模块</a></li> <li><a href='ClassManage.aspx'>班级管理</a></li><li>添加班级</li>");
    ...
    protected void EBtnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            int txt_Groupid = DataConverter.CLng(Request.Form["classid"].ToString());
