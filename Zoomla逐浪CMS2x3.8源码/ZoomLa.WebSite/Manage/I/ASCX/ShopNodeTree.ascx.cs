...
public partial class Manage_I_ASCX_ShopNodeTree : System.Web.UI.UserControl
{
    protected B_Node nodeBll = new B_Node();
    string hasChild = "<a onclick='ShowMain(\"\",\"" + CustomerPageAction.customPath2 + "Shop/ProductManage.aspx?NodeID={0}\");' href='javascript:;' id='a{0}' class='list1'><span class='list_span'>{1}</span><span class='fa fa-chevron-down'></span></a>";
    string noChild = "<a onclick='ShowMain(\"\",\"" + CustomerPageAction.customPath2 + "Shop/ProductManage.aspx?NodeID={0}\");'>{1}</a>";
