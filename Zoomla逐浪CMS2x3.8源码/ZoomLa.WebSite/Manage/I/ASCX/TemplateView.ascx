            ...
            <ItemTemplate>
                <li class="padding5">
                    <div data-tlpname="<%#Eval("TemplateUrl") %>" data-tlpid="<%#Eval("TemplateID") %>" class="Template_box">
                        <div class="tempthumil"><a href="javascript:;" onclick="CheckTlp(this,'<%#Eval("TemplateID") %>','<%#Eval("TemplateUrl") %>')" title="点击进入模板管理">
                            <img onmouseover="this.style.border='1px solid #9ac7f0';" onerror="shownopic(this);" onmouseout="this.style.border='1px solid #eeeeee';" alt="点击进入模板管理" style="width: 100%;" src="<%#Eval("TemplatePic") %>"></a></div>
