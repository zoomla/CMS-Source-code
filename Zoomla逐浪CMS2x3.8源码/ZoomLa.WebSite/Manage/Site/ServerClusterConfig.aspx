<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ServerClusterConfig.aspx.cs" Inherits="Manage_Site_ServerClusterConfig" MasterPageFile="~/Manage/I/Default.master"%> 
        ...
        <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="True" RowStyle-CssClass="tdbg" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="密码" Visible="false">
                    <EditItemTemplate>
                        <asp:TextBox runat="server" ID="eSitePasswd" Text='<%#GetPwd(Eval("SitePasswd")as string) %>' MaxLength="50"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
