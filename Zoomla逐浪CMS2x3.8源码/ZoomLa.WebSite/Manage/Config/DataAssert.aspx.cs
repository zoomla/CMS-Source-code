...
public partial class manage_Config_DataAssert_ : CustomerPageAction
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        B_Data bdata = new B_Data();
        if (bdata.UpdateData(TargetField, ShiftField, DbTable, DbFieldlist))
        {
            function.WriteSuccessMsg("替换成功!");
        }
    }
