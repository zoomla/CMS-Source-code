...
public partial class Manage_Design_Ask_QuestionList : CustomerPageAction
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Call.SetBreadCrumb(Master, "<li><a href='" + customPath2 + "Main.aspx'>工作台</a></li><li><a href='Default.aspx'>动力模块</a></li><li><a href='AskList.aspx'>问卷调查</a></li><li class='active'>" + askMod.Title + "[<a href='javascript:;'>添加问题</a>]</li>");
        }
    }
    public void MyBind()
    {
    ...
    protected void EGV_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row != null && e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Attributes.Add("ondblclick", "location='EditQuestion.aspx?ID=" + dr["ID"] + "'");
        }
    }
}