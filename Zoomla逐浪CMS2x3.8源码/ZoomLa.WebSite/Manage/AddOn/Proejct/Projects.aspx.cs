...
public partial class manage_AddOn_Projects : System.Web.UI.Page
{
    ...
    protected string GetProType(string typeid)
    {
        ...
        M_Pro_Type typeMod = ptBll.SelReturnModel(id);
        if (typeMod == null) { return ""; }
        return typeMod.TName;
    }
    ...
    {
        M_AdminInfo admin = B_Admin.GetAdminByID(DataConverter.CLng(id));
