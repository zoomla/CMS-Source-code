...
public partial class Manage_I_Guest_ReplyGuest : CustomerPageAction
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Call.SetBreadCrumb(Master, "<li><a href='" + CustomerPageAction.customPath2 + "I/Main.aspx'>工作台</a></li><li><a href='ContentManage.aspx'>内容管理</a></li><li><a href='WdCheck.aspx'>百科问答</a></li><li><a href='GuestCateMana.aspx'>留言分类管理</a></li><li><a href='Default.aspx?CateID=" + Request.QueryString["CateID"] + "'>" + str + "</a></li><li class='active'>回复留言</li>");
    }
    ...
    protected void EBtnSubmit_Click(object sender, EventArgs e)
    {
        ...
        info.TContent = BaseClass.CheckInjection(this.tx_Content.Text);
        info.Status = 1;
