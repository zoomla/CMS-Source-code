...
namespace ZoomLa.BLL
{
    class CollectionField
    {
        ...
        public string GetMultipleTextType(string Alias, string Name,  string Content, string Description, DataRow dr)
        {
            ...
            builder.Append("<input type='text' name=\"txt_" + Name + "\" style=\"width:200px;\" class=\"form-control\" value=\"" + HttpUtility.UrlDecode(dr["" + Name + ""].ToString()) + "\" />");
            return builder.ToString();
        }
        #endregion
        ...
        public string GetNumberType(string Alias, string Name,  string Content, string Description, DataRow dr)
        {
            ...
            builder.Append("<input type=\"txt\" name=\"txt_" + Name + "\"  style=\"width:200px;\" class=\"form-control\" value=\"" + HttpUtility.HtmlEncode(dr["" + Name + ""].ToString()) + "\"> ");
            return builder.ToString();
        }
        #endregion
        ...
        public string GetTextType(string Alias, string Name,  string Content, string Description, DataRow dr)
        {
            try
            {
                ...
                builder.Append("<input type=\"" + type + "\" name=\"txt_" + Name + "\" class=\"form-control\" style=\"width:200px;\" value=\"" + HttpUtility.HtmlEncode(dr["" + Name + ""].ToString()) + "\"> ");
                return builder.ToString();
            }
            catch(Exception ex)
            {
        ...
        private string GetSuperLinkType(string Alias, string Name,  string Content, string Description, DataRow dr)
        {
            ...
            builder.Append("<input type=\"text\" name=\"txt_" + Name + "\" size=\"" + strArray2[1] + "\" value=\"" + HttpUtility.HtmlEncode(dr["" + Name + ""].ToString()) + "\"> " );
            builder.Append("</td>\r\n</tr>\r\n");
            return builder.ToString();
        }
        #endregion
        ...
        private string GetOperatingType(string Alias, string Name,  string Content, string Description, DataRow dr)
        {
            ...
            str = "<input type=\"text\" name=\"txt_" + Name + "\" size=\"" + strArray2[1] + "\" value=\"" + HttpUtility.HtmlEncode(dr["" + Name + ""].ToString()) + "\"><br/>";
            str = str + str3;
            builder.Append(str);
            builder.Append("</td>\r\n</tr>\r\n");
            return builder.ToString();
