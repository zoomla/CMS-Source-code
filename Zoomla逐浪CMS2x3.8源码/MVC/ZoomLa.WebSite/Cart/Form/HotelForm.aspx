<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HotelForm.aspx.cs" Inherits="ZoomLaCMS.Cart.Form.HotelForm" MasterPageFile="~/Cart/order.master" EnableViewStateMac="false"%>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="container">
        <div class="panel panel-primary">
          <div class="panel-heading"><span class="fa fa-plane"></span><span class="margin_l5">商品信息</span></div>
  ...
  <%--  <div><strong>保险数量:</strong><asp:TextBox runat="server" ID="Safenum_T" CssClass="form-control" /></div>--%>
    <div class="panel panel-primary">
        <div class="panel-heading"><span class="fa fa-user"></span><span class="margin_l5">客人信息</span></div>
        <div class="panel-body">
            <ul id="user_ul">
        <li>
            <table class='table table-bordered'>
