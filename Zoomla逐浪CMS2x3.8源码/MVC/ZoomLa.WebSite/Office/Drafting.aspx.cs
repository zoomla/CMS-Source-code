...
namespace ZoomLaCMS.MIS.OA
{
    public partial class Drafting : System.Web.UI.Page
    {
        ...
        private void TypeDataBind()
        {
            ...
            dt = bmis.Sel(1);
            DocType_DP.DataSource = dt;
            DocType_DP.DataTextField = "ModelName";
            DocType_DP.DataValueField = "ID";
            DocType_DP.DataBind();
            DocType_DP.Items.Insert(0, new ListItem("请选择", "0"));
        }
        ...
        public M_OA_Document FillMod(int status, M_OA_Document oaMod = null)
        {
            ...
            else { oaMod.ProType = (int)M_MisProcedure.ProTypes.Free; }
