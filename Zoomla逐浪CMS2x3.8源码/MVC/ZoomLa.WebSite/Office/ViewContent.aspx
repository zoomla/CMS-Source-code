<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewContent.aspx.cs" Inherits="ZoomLaCMS.MIS.OA.ViewContent" MasterPageFile="~/Common/Master/UserEmpty.master" %>
...
<div class="draftnav">
    <a href="/Office/Main.aspx">行政公文</a>/<a href="ContentManage.aspx?NodeID=<%=Request.QueryString["NodeID"] %>">内容管理</a>/<span>浏览内容</span>
</div>
<div id="site_main" style="margin:10px;">
    <table class="table_li table-border" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td>标题:</td><td colspan="3"><asp:Label ID="Title_T" runat="server" /></td>
