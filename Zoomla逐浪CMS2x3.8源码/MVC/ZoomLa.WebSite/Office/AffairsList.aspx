<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AffairsList.aspx.cs" Inherits="ZoomLaCMS.MIS.OA.AffairsList"  MasterPageFile="~/Common/Master/UserEmpty.master" %>
...
<div class="draftnav">
    <a onclick="javascript:parent.window.location.href='/Office/'">行政公文</a>/<a href="AffairsList.aspx?view=<%:CurrentView %>"><asp:Label ID="Label1" runat="server" Text=""></asp:Label></a>
</div>
