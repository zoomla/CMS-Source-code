<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Producer.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.Producer" ValidateRequest="false" MasterPageFile="~/Manage/I/Default.master"%>
