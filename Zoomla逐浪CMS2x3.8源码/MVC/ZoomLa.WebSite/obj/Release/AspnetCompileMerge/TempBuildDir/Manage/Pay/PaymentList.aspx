<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentList.aspx.cs" Inherits="ZoomLaCMS.Manage.Pay.PaymentList" MasterPageFile="~/Manage/I/Default.master" %>
        ...
        <ItemTemplate>
            <tr ondblclick="location.href='DepostDetail.aspx?ID=<%#Eval("PaymentID") %>';">
                ...
                <td>
                    ...
                    <a href="DepostDetail.aspx?ID=<%#Eval("PaymentID") %>" class="option_style"><i class="fa fa-eye" title="浏览"></i>浏览</a>
                </td>
            </tr>
        </ItemTemplate>
