<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyList.aspx.cs" Inherits="ZoomLaCMS.MIS.OA.Flow.ApplyList" MasterPageFile="~/Common/Master/UserEmpty.master" %>  
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <ol id="BreadNav" class="breadcrumb navbar-fixed-top">
        ...
        <li><a href="/Office/Main.aspx">流程管理</a></li>
        <li class="active"><asp:Label runat="server" ID="CurView_L"></asp:Label>(提示：支持自定义分类，分类格式为：/Office/Flow/ApplyList.aspx?view=3&proid=[流程ID])</li>
    </ol>
