<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ZoomLaCMS.MIS.OA.Office.Default" MasterPageFile="~/Common/Master/UserEmpty.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="draftnav"><a href="/Office/Main.aspx">行政公文</a>/<a href="Default.aspx">发文管理</a><a href="javascript:;" style="margin-left:5px;">提示：已开始审批的文件无法修改删除</a></div>
