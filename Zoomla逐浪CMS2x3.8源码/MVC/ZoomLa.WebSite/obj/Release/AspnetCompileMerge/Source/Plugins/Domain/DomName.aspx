<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DomName.aspx.cs" Inherits="ZoomLaCMS.Plugins.Domain.DomName" MasterPageFile="~/Manage/Site/SiteMaster2.master" %>
...
<div id="site_main">
    <div id="leftDiv">
        <div class="panel panel-primary">
          ...
          <div class="list-group">
            <a href="javascript:;" id="tabBtn1" onclick="ShowTabs(this,'tab1');openFrame('/Site/Domain?remote=true')" class="list-group-item">域名注册</a>
            <a href="javascript:;" class="list-group-item" id="tabBtn3" onclick="ShowTabs(this,'tab3')">域名管理</a>
            <a href="/Site/Default" target="_blank" class="list-group-item">智能建站</a>
    ...
    <div id="rightDiv">
    <div id="tab1">
        <iframe id="tab1Frame" src="/Site/Domain?remote=true" style="width:98%;height:700px;" frameborder=0 scrolling=yes></iframe>
</div>
