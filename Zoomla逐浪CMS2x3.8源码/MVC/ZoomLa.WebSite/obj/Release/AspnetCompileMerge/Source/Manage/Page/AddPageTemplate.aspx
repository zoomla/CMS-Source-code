<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPageTemplate.aspx.cs" Inherits="ZoomLaCMS.Manage.Page.AddPageTemplate" MasterPageFile="~/Manage/I/Default.master" ValidateRequest="false" %>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr id="Tr18">
                    <td colspan="2" align="center">
                        ...
                        <asp:Button ID="Button1" runat="server" Text="保存信息" class="btn btn-primary" OnClick="Button1_Click" />
