<%@ Page Language="C#" MasterPageFile="~/Manage/I/Default.master" AutoEventWireup="true" CodeBehind="AddProjects.aspx.cs" ValidateRequest="false" Inherits="ZoomLaCMS.Manage.AddOn.Project.AddProjects" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="Server">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input id="Button3" type="button" value="选择负责人" data-toggle="modal" data-target="#userinfo_div" onclick="ShowUserInfo1(); void (0)" class="btn btn-info" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <ZL:TextBox ID="WebCoding" runat="server" AllowEmpty="false" class="form-control text_300"></ZL:TextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <div style="text-align: center">
        ...
        <asp:Button ID="Cancel" runat="server" Text="重置" class="btn btn-info" OnClick="Cancel_Click"  />
    </div>
