<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddQuestion_Class.aspx.cs" Inherits="ZoomLaCMS.Manage.Exam.AddQuestion_Class"  EnableViewStateMac="false" MasterPageFile="~/Manage/I/Default.master"%>
<asp:Content runat="server" ContentPlaceHolderID="head"><title>编辑分类</title></asp:Content>
