<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Group.aspx.cs" Inherits="ZoomLaCMS.Manage.User.GroupPage"   MasterPageFile="~/Manage/I/Default.master"%>
  ...
  <table class="table table-striped table-bordered table-hover">
    ...
    <tr>
      <td colspan="2" class="text-center">
        ...
        <a href="GroupManage.aspx" class="btn btn-primary">返回列表</a></td>
    </tr>
  </table>
</asp:Content>
