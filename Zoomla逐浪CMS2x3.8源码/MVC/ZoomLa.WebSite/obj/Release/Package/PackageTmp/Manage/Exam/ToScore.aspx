<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ToScore.aspx.cs" Inherits="ZoomLaCMS.Manage.Exam.ToScore" EnableViewStateMac="false" MasterPageFile="~/Manage/I/Default.master"%>
    ...
    <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="试卷名称">
                <ItemTemplate><a href="/User/Exam/ExamDetail?ID=<%#Eval("PaperID")+"&Action=View&FlowID="+Eval("FlowID") %>" target="_blank" title="查看详情"><%#Eval("PaperName") %></a></ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="td_l">
                <ItemTemplate>
                    <a target="_blank" href="/User/Exam/ExamDetail?ID=<%#Eval("PaperID")+"&Action=View&FlowID="+Eval("FlowID") %>" class="option_style"><i class="fa  fa-pencil-square-o" title="批阅"></i>批阅试卷</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
