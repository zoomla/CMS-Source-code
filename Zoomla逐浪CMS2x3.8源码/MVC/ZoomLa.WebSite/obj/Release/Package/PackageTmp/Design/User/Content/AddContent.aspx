<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddContent.aspx.cs" Inherits="ZoomLaCMS.Design.User.Content.AddContent" MasterPageFile="~/Design/Master/User.master" ValidateRequest="false" %>
