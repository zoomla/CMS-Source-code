...
function ShowAdd(id) {
    ...
    comdiag.reload = true;
    ShowComDiag("/User/Exam/AddSmallQuest"+(id?"?id="+id:""), "添加小题");
}
function ShowSel() {
    var url = "/User/Exam/SelQuestion?type=1&islage=1&selids=," + $("#Qids_Hid").val() + ",";
...
function ShowQuestType() {
    ...
    comdiag.reload = true;
    ShowComDiag("/User/Exam/QuestOption?id=" + $("#Id_hid").val(), "试题信息");
}
