...
function (e) {
    ...
    function r(r, u, o) {
        "function" == typeof r && (r = String(r).replace(/^[^\{]*\{\s*\/\*!?[ \f\t\v]*\n?|[ \f\t\v]*\*\/[;|\s]*\}$/g, ""));
        var i = t(r),
			c = function (t, r) {
			    var u = [];
			    return "undefined" == typeof r && (r = function (t) {
			        i.call(t, u, n, r, e)
			    }), i.call(t, u, n, r, e), u.join("")
			};
        return arguments.length <= 1 ? c : c(u, o)
    }
    var u = {
        '"': "quot",
        "<": "lt",
...
//# sourceMappingURL=jhtmls.min.js.map