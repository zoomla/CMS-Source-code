var emotion = { $cur: null, param: {} };
emotion.$em = $('<iframe src="/Plugins/Ueditor/dialogs/emotion/ImgFace.html" class="emotion_ifr" id="emotion_ifr"></iframe>');
emotion.open = function (obj, param) {
    var ref = this;
    var $obj = $(obj);
    ref.$cur = $obj;
    ref.param = param;
    ...
    if ($em.length > 0) { ref.$em.hide(); }
    else { $obj.after(ref.$em); ref.$em.show(); }
}
emotion.close = function () { emotion.$em.hide(); }
emotion.data = {
...
emotion.strToEmotion = function (str) {
    var ref = this;
    if (!str || str == "" || str.indexOf("]") < 0) { return str; }
    var baseurl = "/Plugins/Ueditor/dialogs/emotion/images/";//jx2/j_0001.gif";
    for (var i = 0; i < 7; i++) {
        if (str.indexOf("]") < 0) { return str; }
        var tab = ref.data.SmileyInfor["tab" + i];
        var url = ref.data.imageFolders["tab" + i] + ref.data.SmilmgName["tab" + i][0];
