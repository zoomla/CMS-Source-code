<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MsgInfo.aspx.cs" Inherits="ZoomLaCMS.Manage.User.Service.MsgInfo" ValidateRequest="false" MasterPageFile="~/Manage/I/Default.master" %>
