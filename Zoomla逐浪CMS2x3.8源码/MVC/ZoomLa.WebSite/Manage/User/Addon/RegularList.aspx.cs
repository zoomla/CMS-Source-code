...
namespace ZoomLaCMS.Manage.User.Addon
{
    public partial class RegularList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                MyBind();
                Call.SetBreadCrumb(Master, "<li><a href='" + CustomerPageAction.customPath2 + "Main.aspx'>工作台</a></li><li><a href='../UserManage.aspx'>用户管理</a></li><li class='active'>规则列表 [<a href='AddRegular.aspx'>添加规则</a>]</li>");
            }
        }
        private void MyBind()
        {
