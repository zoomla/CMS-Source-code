...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <div class="checkdiv">
                    <label><input type="checkbox" onclick="checkall(this);" name="OAMeetingManage" id="OAMeetingManage" value="OAMeetingManage" />会议权限</label>
                    
                </div>
                <div class="checkdiv">
                    <label><input type="checkbox" id="OATop" name="OATop" onclick="showtext(this)"  value="OATop" /> 置顶权限</label>
                ...
                <div class="checkdiv">
                    <label><input type="checkbox" id="OADel" name="OADel" onclick="showtext(this)" value="OADel" /> 删除权限</label>
                ...
                <div class="checkdiv">
                    <label><input type="checkbox" id="OAEdit" name="OAEdit" onclick="showtext(this)" value="OAEdit" /> 修改权限</label>
                ...
                <div class="checkdiv">
                    <label><input type="checkbox" name="OATaskManage" id="OATaskManage" value="OATaskManage" />任务管理器</label>
                </div>
                <div class="checkdiv">
                    <label><input type="checkbox" onclick="checkall(this);" name="OAEmailManage" id="OAEmailManage" value="OAEmailManage" />邮件权限<br /></label>
                    <label><input type="checkbox" name="OAEmailManage" id="Checkbox9" value="OAEmailWrite" />写邮件权限</label>
                    <label><input type="checkbox" name="OAEmailManage" id="Checkbox1" value="OAEmailRead" />读邮件权限</label>
                    <label><input type="checkbox" name="OAEmailManage" id="Checkbox2" value="OAEmailContact " />邮件联系人权限</label>
                </div>
                <div class="checkdiv">
                    <label><input type="checkbox" onclick="checkall(this);" name="OADepartmentManage" id="OADepartmentManage" value="OADepartmentManage" />部门公告权限</label>
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <label><input type="checkbox" name="ContentManage" id="ContentManage" value="ContentManage" />内容管理</label>
                <label><input type="checkbox" name="ModelNodeManage" id="ModelNodeManage" value="ModelNodeManage" />模型节点管理</label>
                <label><input type="checkbox" name="TemplateLabelManage" id="TemplateLabelManage" value="TemplateLabelManage" />模板标签管理</label>
                <label><input type="checkbox" name="ShopManage" id="ShopManage" value="ShopManage" />商城管理</label>
                <label><input type="checkbox" name="PageManage" id="PageManage" value="PageManage" />黄页管理</label>
                <label><input type="checkbox" name="UserShopManage" id="UserShopManage" value="UserShopManage" />店铺管理</label>
                <label><input type="checkbox" name="UserZoneManage" id="UserZoneManage" value="UserZoneManage" />空间管理</label>
            </td>
        </tr>
