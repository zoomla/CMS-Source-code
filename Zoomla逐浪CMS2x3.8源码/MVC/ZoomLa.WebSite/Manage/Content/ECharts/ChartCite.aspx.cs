...
{
    public partial class ChartCite : CustomerPageAction
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Cite_T.Text = "<iframe src='http://" + Request.Url.Authority + "/Plugins/ECharts/ShowM.aspx?ID=" + Mid + "' style='width:700px;height:500px;'></iframe>";
