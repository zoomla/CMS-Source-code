...
function FixedZoneAD_Show() {
  ...
  document.write("<div id='" + this.DivName + "' style='position:absolute; visibility:visible; z-index:1; max-width:" + this.ZoneWidth + "px; height:" + this.ZoneHeight + "px; left:" + this.Left + "px;top:" + this.Top + "px'>" + AD_Content(this.ShowAD) + "");
  if(this.ShowCloseAD){
