namespace ZoomLaCMS.Manage.Guest
{
    ...
    public partial class BarConfig : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (GType.Equals("1")) { Call.SetBreadCrumb(Master, "<li><a href='" + CustomerPageAction.customPath2 + "I/Main.aspx" + "'>工作台</a></li><li><a href='GuestCateMana.aspx'>贴吧栏目管理</a></li><li class='active'>添加栏目</li>"); }
                else { Call.SetBreadCrumb(Master, "<li><a href='" + CustomerPageAction.customPath2 + "I/Main.aspx" + "'>工作台</a></li><li><a href='GuestManage.aspx'>留言分类管理</a></li><li class='active'>添加留言分类</li>"); }
            }
        }
        public void DBBind()
        {
