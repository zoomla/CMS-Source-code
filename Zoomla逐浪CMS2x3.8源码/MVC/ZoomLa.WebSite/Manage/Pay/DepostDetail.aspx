...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-bordered table-striped">
        <tr><td class="td_m">支付单号：</td>  <td><asp:Label runat="server" ID="PayNo_L"></asp:Label></td></tr>
        <tr><td class="td_m">订单编号：</td>  <td><asp:Label runat="server" ID="OrderNo_L"></asp:Label></td></tr>
        <tr><td>付款状态：</td><td><asp:Label runat="server" ID="PayStatus_L"></asp:Label></td></tr>
        <tr><td>处理结果：</td><td><asp:Label runat="server" ID="CStatus_L"></asp:Label></td></tr>
        <tr><td>会 员 名 ：</td><td><asp:Label runat="server" ID="UserName_L"></asp:Label></td></tr>
        ...
        <tr><td></td>
        <td> 
            <asp:Button ID="ForceSucc_B" runat="server" Visible="false" CssClass="btn btn-primary" Text="强制成功" OnClientClick="return confirm('确定要强制改变支付单状态吗?');" OnClick="ForceSucc_B_Click" />
