...
{
    public partial class AddCard : CustomerPageAction
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                createtime_T.Text = DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss");
                endtime.Text = DateTime.Now.AddYears(1).ToString("yyyy/MM/dd HH:mm:ss");
