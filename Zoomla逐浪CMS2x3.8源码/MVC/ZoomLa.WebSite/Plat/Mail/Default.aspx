<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ZoomLaCMS.Plat.Mail.Default"  MasterPageFile="~/Plat/Main.master"  ValidateRequest="false"%>
...
<%--  <div class="container-fluid">
  ...
  <div class="mainDiv container platcontainer">
    ...
    <div class="us_seta" style="margin-top: 5px;">
      ...
      <asp:Button runat="server" ID="batDelBtn" Text="批量删除" OnClick="batDelBtn_Click" CssClass="btn btn-info" />
      <asp:Button runat="server" ID="batReadBtn" Text="设为已读" OnClick="batReadBtn_Click" CssClass="btn btn-info" />
    </div>
  </div>
</asp:Content>
