<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MessageDraftbox.aspx.cs" Inherits="ZoomLaCMS.Plat.Mail.MessageDraftbox"  MasterPageFile="~/Plat/Main.master"  ValidateRequest="false"%>
...
<asp:Button ID="Button3" runat="server" Font-Size="9pt" Text="批量删除" OnClick="Button2_Click" OnClientClick="return confirm('确定要删除吗,草稿箱删除的邮件不会进入回收站!!');" class="btn btn-info" />
</div>
</div>
</asp:Content>