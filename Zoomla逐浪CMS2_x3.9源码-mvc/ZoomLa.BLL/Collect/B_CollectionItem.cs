namespace ZoomLa.BLL
{
    ...
    public class B_ContentField
    {
        ...
        public string GetMultipleHtmlType(string Alias, string Name, bool IsNotNull, string Content, string Description, DataRow dr)
        {
            ...
            if (!(str3 == "1"))
            {
                if (str3 != "2")
                {
                    ...
                    if (SiteConfig.SiteOption.EditVer == "2")
                    {
                        builder.AppendLine("<textarea cols=\"80\" id=\"txt_" + Name + "\" style=\"width:" + strArray2[1] + "px;height:" + strArray3[1] + "px;visibility:hidden;\" name=\"txt_" + Name + "\" rows=\"10\">" + function.HtmlEncode(dr["" + Name + ""].ToString()) + "</textarea>");
                        builder.AppendLine(@"<script type=""text/javascript"">");
                        builder.AppendLine(@"KE.show({");
                        builder.AppendLine("id : 'txt_" + Name + "'");
                        builder.AppendLine(@"});");
                    ...
                    {//百度编辑器
                        builder.AppendLine("<textarea cols=\"80\" id=\"txt_" + Name + "\"  style=\"width:" + strArray2[1] + "px;height:" + strArray3[1] + "px;\"  name=\"txt_" + Name + "\" rows=\"10\">" + function.HtmlEncode(dr["" + Name + ""].ToString()) + "</textarea>");
                        builder.AppendLine(@"<script type=""text/javascript"">");
                        builder.AppendLine(@"setTimeout(function(){UE.getEditor('txt_" + Name + "');},500);");
                        builder.AppendLine(@"</script>");
                    ...
                    {
                        builder.AppendLine("<textarea cols=\"80\" id=\"txt_" + Name + "\" width=\"" + strArray2[1] + "px\" height=\"" + strArray3[1] + "px\" name=\"txt_" + Name + "\" rows=\"10\">" + function.HtmlEncode(dr["" + Name + ""].ToString()) + "</textarea>");
                        builder.AppendLine("<script id=\"headscript\" type=\"text/javascript\">");
                        builder.AppendLine("//<![CDATA[");
                        builder.AppendLine("CKEDITOR.replace('txt_" + Name + "',");
                        builder.AppendLine("{");
        ...
        public string GetMultipleTextType(string Alias, string Name, bool IsNotNull, string Content, string Description, DataRow dr)
        {
            ...
            builder.Append("<textarea name=\"txt_" + Name + "\" id=\"txt_" + Name + "\" style=\"height:" + strArray3[1] + "px;width:" + strArray2[1] + "px;\">" + function.Decode(dr["" + Name + ""].ToString()) + "</textarea> " + str2 + " " + Description + "");
            builder.Append("</td>\r\n</tr>\r\n");
            return builder.ToString();
        }
        //数字
        ...
        public string GetTextType(string Alias, string Name, bool IsNotNull, string Content, string Description, DataRow dr)
        {
            ...
            builder.Append("<input type=\"" + strArray3[1] + "\"  id=\"txt_" + Name + "\" name=\"txt_" + Name + "\" size=\"" + strArray2[1] + "\" value=\"" + function.HtmlEncode(dr["" + Name + ""].ToString()) + "\" /> " + str2 + " " + Description + "");
            builder.Append("</td>\r\n</tr>\r\n");
            return builder.ToString();
        }
        //超链接
        ...
        private string GetOperatingType(string Alias, string Name, bool IsNotNull, string Content, string Description, DataRow dr)
        {
            ...
            str = "<input type=\"text\" name=\"txt_" + Name + "\" id=\"txt_" + Name + "\" size=\"" + strArray2[1] + "\" value=\"" + function.HtmlEncode(dr["" + Name + ""].ToString()) + "\" /> " + str2 + " " + Description + "<br/>";
            str = str + str3;
            builder.Append(str);
            builder.Append("</td>\r\n</tr>\r\n");
            return builder.ToString();
        ...
        public string GetColorType(string Alias, string Name, bool IsNotNull, string Content, string Description, DataRow dr)
        {
            ...
            builder.Append("<input type=\"text\" name=\"txt_" + Name + "\" maxlength=\"7\"  size=\"7\"  value=\"" + function.HtmlEncode(dr["" + Name + ""].ToString()) + "\" /> " + str2 + " " + Description + "");
            builder.Append("<img onclick=\"SelectColor(this,'txt_" + Name + "');\" src=\"/images/Rect.gif\" align=\"absmiddle\" style=\"border-width: 0px; cursor: pointer\" /></td>\r\n</tr>\r\n");
            return builder.ToString();
        }
        /*********************************************************************************************************************************************************/
