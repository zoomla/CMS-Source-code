...
namespace ZoomLa.BLL
{
    ...
    public class B_CreateHtml
    {
        ...
        public string GetPage(string content, string fname, string fileex, int cpage, int pageCount, int psize)
        {
            ...
            #endregion
            //静态页生成时无参数需要处理,默认为空
            //ZLLog.L("html:" + currentUrl + ":" + firsturl + ":" + fname + "_");
        ...
        public string GetPage(string content, int infoID, int cpage, int pageCount, int psize)
        {
            ...
            //}
            #endregion
            //ZLLog.L("aspx:" + currentUrl + ":" + firsturl + ":");
        ...
        private static string SysLabelProc(string syslabel)
        {
            ...
            switch (lbl)
            {
                ...
                //case "LastUser":
                //    //string result = "";
                //    //if (CurrentReq.Request.Cookies["UserState2"] != null && !string.IsNullOrEmpty(CurrentReq.Request.Cookies["UserState2"]["UserName"]))
                //    //{
                //    //    result = CurrentReq.Request.Cookies["UserState2"]["UserName"];
                //    //}
                //    return result;
                default:
        ...
        {
            return GetUrl() + "/Special_" + funparam + "/List.aspx";
        }
        //专题列表页
        private string GetSpecialPage(int funparam)
        {
            return GetUrl() + "/Special_" + funparam + "/Default.aspx";
        }
        #endregion
        #region 新标签
        /// <summary>
