...
namespace ZoomLa.BLL
{
    public class B_GuestBook
    {
        ...
        public bool AddTips(M_GuestBook model)
        {
            ...
            {
                Sql.UpdateByID(model.TbName, model.PK, model.GID, BLLCommon.GetFieldAndPara(model), model.GetParameters(model));
            }
            return true;
        }
        /// <summary>
        ...
        /// </summary>
        public static DataTable GetAllTips(int CateID, int status,string skey="")
        {
