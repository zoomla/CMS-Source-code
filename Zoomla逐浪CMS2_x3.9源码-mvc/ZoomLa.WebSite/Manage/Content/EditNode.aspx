                            ...
                            <ZL:ExGridView runat="server" ID="GroupAuth_EGV" AutoGenerateColumns="false" EnableTheming="False" CssClass="table table-striped table-bordered table-hover" DataKeyNames="GroupID">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="查看">
                                        <HeaderStyle Width="7%" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="CheckBox1" runat="server" Checked='<%#GroupAuth("look") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="录入">
                                        <HeaderStyle Width="7%" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="CheckBox2" runat="server" Checked='<%#GroupAuth("addTo") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="修改">
                                        <HeaderStyle Width="7%" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="CheckBox3" runat="server" Checked='<%#GroupAuth("Modify") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="删除">
                                        <HeaderStyle Width="7%" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="CheckBox4" runat="server" Checked='<%#GroupAuth("Deleted") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="仅当前节点">
                                        <HeaderStyle Width="15%" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="CheckBox5" runat="server" Checked='<%#GroupAuth("Columns") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="评论管理">
                                        <ItemTemplate>
                                            <asp:CheckBox ID="CheckBox6" runat="server" Checked='<%#GroupAuth("Comments") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                </Columns>
