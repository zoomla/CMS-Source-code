...
{
    public partial class EditScene : CustomerPageAction
    {
        ...
        public void MyBind()
        {
            ...
            UserName_L.Text = "<a href='javascript:;' onclick='showuser(" + pageMod.UserID + ")' title='查看用户' >" + pageMod.UserName + "</a>";
            ...
            string looklink = "/design/h5/preview.aspx?id=" + pageMod.guid;
