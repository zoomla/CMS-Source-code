...
window.___E_mod(function (E, $) {
	...
	E.config = {
		...
		// 表情图标配置
		happy: [//edit
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f01.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f02.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f03.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f04.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f05.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f06.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f07.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f08.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f09.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f10.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f11.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f12.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f13.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f14.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f15.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f16.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f17.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f18.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f19.gif',
			'/Plugins/Ueditor/dialogs/emotion/images/face/i_f20.gif'
		],

		// 上传图片
		uploadImgUrl: '/Plugins/Uploadify/Base64.ashx',
		...
		loadingImg: '/design/res/img/spinner.jpg',
	};
...
window.___E_mod(function (E, $) {
	E.fn.addMenuImg = function (menuId) {
		...
		var idDebugger = true;  // 默认为 false，下文可能修改
			...
			bindEvent: function (editor) {
				...
				$inputFlie.on('change', function (e) {
					...
					reader.onload = function(e){
			            ...
			            //formData.append('file', convertBase64UrlToBlob(base64, fileType));//fileup
			            formData.append("base64", base64);//edit
			            xhr.send(formData);
...
//<script src="/Design/h5/js/zepto.touch.js"></script>
...
//    editor.$txt.html("<span style='color:red;'>wtwtwtwt</span>");
//    editor.init();
//});