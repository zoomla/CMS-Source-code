<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreShop.aspx.cs" Inherits="ZoomLaCMS.Store.StoreShop" %>
...
<body>
   ...
   <input name="id" type="text" id="id" value="2" />
    ...
    <input name="Pronum" type="text" id="Pronum" value="1" />
            ...
            <p>
                <label>
                    <asp:Button ID="Savebtn" runat="server" PostBackUrl="~/StoreCart.aspx" Text="提交" />
                </label>
            </p>
        </form>
    </div>
