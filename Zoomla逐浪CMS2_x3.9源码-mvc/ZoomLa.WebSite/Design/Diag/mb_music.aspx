...
<div class="search">
    <div class="search_div">
        ...
        <span id="search_btn" class="text">搜索</span>
    </div>
</div>
<div class="mb_music">
...
.search{position:fixed;top:75px;width:100%;background-color:#fff;}
.search_div{position:relative;height:75px;border-bottom:1px solid #e3e3e3;}
.search_div #Skey_T{height:55px;margin-left:15px; margin-top:10px;border-radius:26px;font-size:25px;padding-left:25px;width:85%;}
.search_div i{position: absolute;right:15%;top:25px; color: #999;background: #fff;font-size:25px;}
...
.mb_music .scroll_wrap{margin-top:150px;margin-bottom:70px;}
...
$("#search_btn").click(function () {  if ($('#Skey_T').val().length > 0) { $("#Search_B").click(); } });
...
$("#icon").click(function () { if ($(this).hasClass("fa-close")) { $("#Skey_T").val(""); } });
</script>
</asp:Content>