<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BindEvent.aspx.cs" Inherits="ZoomLaCMS.Design.Diag.BindEvent"  MasterPageFile="~/Design/Master/Edit.master" %>
    ...
    <tr>
        <td>
            ...
            <select ng-show="click.type==4" ng-model="click.index">
                <option ng-repeat="m in list" value="{{$index}}" ng-selected="{{click.index==$index}}" >{{'第'+($index+1)+'页'}}</option>
            </select>
