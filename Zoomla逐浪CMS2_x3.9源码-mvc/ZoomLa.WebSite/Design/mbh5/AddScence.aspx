<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddScence.aspx.cs" Inherits="ZoomLaCMS.Design.mbh5.AddScence" MasterPageFile="~/Common/Master/Empty.master" %>
...
<h1><asp:Label ID="Title_L" runat="server" Text="创建新场景" /></h1>
</div>
