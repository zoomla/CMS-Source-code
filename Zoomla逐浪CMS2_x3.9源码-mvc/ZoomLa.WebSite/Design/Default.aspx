<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ZoomLaCMS.Design.Default1"  MasterPageFile="~/Common/Master/Empty.master" %>
...
<div class="editor-animation-manager-wrapper">
    <div class="editor-wrapper" style="position: static;">
        <iframe id="design_ifr" class="design_pc" style="height: calc(100% - 63px);"></iframe>
    </div>
