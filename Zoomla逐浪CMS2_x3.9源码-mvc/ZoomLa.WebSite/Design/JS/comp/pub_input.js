    ...
    _self.prototype.Init_Pre = function (model, extend) {
        ...
        switch (model.config.compid) {
            case "text":
                ...
                break;
            case "textarea":
                ref.htmlTlp = '<textarea type="text" style="font-size:24px;width:100%;height:200px;" data-id="@id" placeholder="{{list.@id.config.name}}" maxlength="100" class="pub pub_textarea"></textarea>';
                break;
            default:
