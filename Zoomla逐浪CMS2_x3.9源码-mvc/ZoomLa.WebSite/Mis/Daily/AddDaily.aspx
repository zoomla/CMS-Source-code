<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDaily.aspx.cs" Inherits="ZoomLaCMS.MIS.Daily.AddDaily"  MasterPageFile="~/Common/Master/Empty.master"  %>
...
<div>
    <table class="border staff_frm" width="100%" >
        ...
        <asp:Button ID="Button3" CssClass="C_inputs btn btn-primary" CommandArgument='<%#Eval("ID") %>' CommandName="Edit"   runat="server" Text="确定" />
        ...
        <input id='edtDate_<%#Eval("ID") %>' name='edtDate_<%#Eval("ID") %>'  value="<%#Eval("createtime") %>"  onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" class="M_input"  />
        <asp:Button ID="Button5" CssClass="C_inputs btn btn-primary" CommandArgument='<%#Eval("ID") %>' CommandName="EditDate"   runat="server" Text="确定" />
        ...
        <div> 
             <asp:LinkButton ID="LinkButton3" CommandArgument='<%#Eval("ID") %>' CommandName="SetDel" Text="删除" runat="server" ></asp:LinkButton> 
        <%--<asp:LinkButton ID="lbtDate" CommandArgument='<%#Eval("ID") %>' CommandName="SetDate" Text="延期到" runat="server" ></asp:LinkButton> --%>
        </div>
        </li>
        ...
        <asp:Button ID="Button6" OnClick="Button3_Click" CssClass="btn btn-primary" runat="server" Text="确定" />
        </td></tr>
    </table>      
</div>
