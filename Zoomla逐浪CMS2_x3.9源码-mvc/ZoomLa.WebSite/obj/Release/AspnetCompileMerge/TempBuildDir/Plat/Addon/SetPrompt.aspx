<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetPrompt.aspx.cs" Inherits="ZoomLaCMS.Plat.Addon.SetPrompt"  MasterPageFile="~/Plat/Main.master" %>
<asp:Content runat="server" ContentPlaceHolderID="head"><title>提示管理</title></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="container platcontainer">
        ...
        <table class="table table-bordered table-striped">   
            ...
            <tr><td>提示内容</td><td><asp:TextBox runat="server" ID="Content_T" CssClass="form-control text_300" TextMode="MultiLine" style="height:120px;" MaxLength="2000" /></td></tr>
            <tr><td>提示时间</td><td><asp:TextBox runat="server" ID="BeginDate_T" onclick="WdatePicker();" CssClass="form-control text_300"/></td></tr>
            <tr><td>提示用户</td><td>
