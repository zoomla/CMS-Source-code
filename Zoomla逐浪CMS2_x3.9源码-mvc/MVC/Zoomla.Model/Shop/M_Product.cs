...
namespace ZoomLa.Model
{
    ...
    public class M_Product:M_Base
    {
        ...
        string[,] Tablelist = {
                                ...
                                {"FestlPrice","Money","32"},
                                {"FestPeriod","NVarChar","4000"},
                                {"ColonelTime","NVarChar","4000"},  
                                {"ColoneDeposit","Money","16"},
        ...
        public M_Product GetModelFromReader(SqlDataReader rdr)
        {
            ...
            model.FestlPrice = ConverToDouble(rdr["FestlPrice"]);
            model.FestPeriod = ConverToStr(rdr["FestPeriod"]);
            model.ColonelTime = ConverToStr(rdr["ColonelTime"]);
            model.ColoneDeposit = ConverToDouble(rdr["ColoneDeposit"]);
        ...
        public override SqlParameter[] GetParameters()
        {
            ...
            sp[73].Value = model.FestlPrice;
            sp[74].Value = model.FestPeriod;
            sp[75].Value = model.ColonelTime;
            sp[76].Value = model.ColoneDeposit;
            sp[77].Value = model.FarePrice;
            sp[78].Value = model.ExpRemind;
            sp[79].Value = model.LinPrice_Json;
            sp[80].Value = model.ParentID;
            sp[81].Value = model.UserID;
            sp[82].Value = model.UserShopID;
            sp[83].Value = model.BindIDS;
            sp[84].Value = model.OrderID;
            sp[85].Value = model.IDCPrice;
            sp[86].Value = model.Recycler;
            return sp;
        }
    }
    [Serializable]
