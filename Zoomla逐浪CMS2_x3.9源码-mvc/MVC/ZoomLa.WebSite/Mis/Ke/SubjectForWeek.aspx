<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubjectForWeek.aspx.cs" Inherits="ZoomLaCMS.MIS.Ke.SubjectForWeek"  MasterPageFile="~/Common/Common.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-7">
          <ul class="nav navbar-nav dailyplan_nav">
            ...
            <li class="active"><a href="SubjectForWeek.aspx<%=Request.Url.Query %>"><span class="fa fa-calendar-plus-o"></span> 周</a></li>
    ...
    <div class="container-fluid">
        <div class="col-md-2">
            ...
            <div class="panel-heading">日程列表[<a href="SubjectForWeek.aspx?type=-1">所有日程</a>]<span class="pull-right"><a href="javascript:;" title="添加日程" onclick="ShowTypeDiag()"><span class="fa fa-plus"></span></a></span></div>
        ...
        <table class="table table-bordered" id="DateTable">
            <thead id="DateTitle" runat="server">
                <tr>
                  <td colspan="8"><asp:LinkButton runat="server" CssClass="btn btn-primary" OnClick="PreWeek_Btn_Click" ToolTip="上一周"><i class="fa fa-chevron-left"></i></asp:LinkButton>
                    <strong style="font-size: 25px; position: relative; top: 4px;">
                    <asp:Label ID="DateSpan_L" runat="server"></asp:Label>
                    </strong>
                    <asp:LinkButton runat="server" CssClass="btn btn-primary" OnClick="NextWeek_Btn_Click" ToolTip="下一周"><i class="fa fa-chevron-right"></i></asp:LinkButton></td>
                </tr>
                <tr>
                  <td></td>
