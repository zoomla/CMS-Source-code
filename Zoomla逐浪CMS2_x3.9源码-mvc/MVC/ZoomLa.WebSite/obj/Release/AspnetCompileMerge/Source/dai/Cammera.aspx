<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cammera.aspx.cs" Inherits="ZoomLaCMS.dai.Cammera" MasterPageFile="~/Common/Master/Empty.master" %>
<asp:Content runat="server" ContentPlaceHolderID="head"><title>在线拍照</title></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="selphoto_div">
        <img id="photo1" src="" onerror="shownoface(this);" style="width:500px;height:375px;" />
    </div>
...
<style>
    ...
    <script>
        ...
        function clearPhoto() {
            StopCamera();
            EnableCamera();
            $(".selphoto_div img").attr('src', "/Images/userface/noface.png");
        }
        //從video元素抓取圖像到canvas
