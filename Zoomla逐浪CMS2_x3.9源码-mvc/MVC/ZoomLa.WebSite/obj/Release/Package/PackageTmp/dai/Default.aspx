<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ZoomLaCMS.dai.Default" MasterPageFile="~/Common/Master/Empty.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div id="box">
        ...
        <ul class="nav nav-tabs" id="nav_dai" role="tablist">
            <li role="presentation" class="active"><a href="#main_tab" aria-controls="main_tab"><span class="fa fa-user"></span>模特试镜</a></li>
            <li role="presentation"><a href="/dai/ReBack.aspx"><span class="fa fa-camera"></span>拍照试戴</a></li>
