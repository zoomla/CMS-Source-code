...
{
    public partial class SetPrompt : System.Web.UI.Page
    {
        ...
        public int MsgID
        {
            get { return DataConvert.CLng(ViewState["MsgID"]); }
        ...
        private void MyBind()
        {
            ...
            if (Mid > 0)
            {
                ...
                BeginDate_T.Text = comMod.BeginDate.ToString("yyyy/MM/dd");
            ...
            else
            {
                ...
                BeginDate_T.Text = DateTime.Now.ToString("yyyy/MM/dd");
