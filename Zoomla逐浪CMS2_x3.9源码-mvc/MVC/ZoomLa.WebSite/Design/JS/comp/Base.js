...
define(function (require, exports, module) {
    ...
    Control.prototype._presave = function () {
        ...
        var styleArr = "position top bottom left right width height margin z-index font-size color text-align text-indent opacity background-color transform font-family".split(' ');
