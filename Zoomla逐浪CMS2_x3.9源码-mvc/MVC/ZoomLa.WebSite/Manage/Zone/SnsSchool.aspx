<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SnsSchool.aspx.cs" Inherits="ZoomLaCMS.Manage.Zone.SnsSchool" MasterPageFile="~/Manage/I/Default.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <ol id="BreadNav" class="breadcrumb navbar-fixed-top">
        ...
        <li class="active">学校管理<a href="AddSchool.aspx">[添加学校]</a></li>
        ...
        <div id="sel_box" class="padding5">
            ...
            <div class="pull-left" style="margin-left: 10px; line-height: 30px;">
                <label>
                    <asp:CheckBox ID="NoProvince_Check" Checked="true" runat="server" />忽略省份</label>
                <label>
                    <asp:CheckBox ID="NoCity_Check" Checked="true" runat="server" />忽略城市</label>
                <label>
                    <asp:CheckBox ID="NoCounty_Check" Checked="true" runat="server" />忽略县</label>
            </div>
        </div>
    </ol>
