    ...
    public partial class wxpay_mp : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    string url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + ZoomLa.BLL.WxPayAPI.WxPayConfig.APPID + "&redirect_uri=" + siteurl + "&response_type=code&scope=snsapi_userinfo&state=redirect#wechat_redirect";
