...
namespace ZoomLa.BLL.AlipayBank
{
    ...
    /// </summary>
    public class B_Alipay_Bank_Submit
    {
        #region 字段
        //支付宝网关地址（新）
        ...
        B_Alipay_Bank_Config config = new B_Alipay_Bank_Config();
        B_Alipay_Bank_AlipayMD5 alipayMD5 = new B_Alipay_Bank_AlipayMD5();
        #endregion

        public B_Alipay_Bank_Submit()
        {
        ...
        private  string BuildRequestMysign(Dictionary<string, string> sPara)
        {
            ...
            string prestr = B_Alipay_Bank_Core.CreateLinkString(sPara);
        ...
        private  Dictionary<string, string> BuildRequestPara(SortedDictionary<string, string> sParaTemp)
        {
            ...
            //过滤签名参数数组
            sPara = B_Alipay_Bank_Core.FilterPara(sParaTemp);
        ...
        private  string BuildRequestParaToString(SortedDictionary<string, string> sParaTemp, Encoding code)
        {
            ...
            string strRequestData = B_Alipay_Bank_Core.CreateLinkStringUrlencode(sPara, code);
