    ...
    public class CreateList
    {
        ...
        public bool CreateListFile(int nodeid)
        {
            ...
            if (nodeid > 0)
            {
                ...
                M_Node Pnid = nll.GetNodeXML(pid);
        ...
        private void SetCreateList(DataTable ntable)
        {
            ...
            for (int ii = 0; ii < ntable.Rows.Count; ii++)
            {
                ...
                M_Node nodeinfos = nll.GetNodeXML(NodeID);
        ...
        public bool CreateFile(string url, int nodeid)
        {
            ...
            M_Node Nodeinfo = nll.GetNodeXML(nodeid);
                                ...
                                if (matcharr[0].IndexOf("=") > -1)//取值
                                {
                                    ...
                                    if (matchchar.Length > 1)
                                    {
                                        ...
                                        if (txturl != "")
                                        {
                                            ...
                                            M_Node mn = nll.GetNodeXML(nll.GetContrarily(Nodeinfo.NodeID, 5));
                ...
                if (listarr.Length > 0)
                {
                    ...
                    if (!string.IsNullOrEmpty(nodeurl))
                    {
                        ...
                        else
                        {
                            ...
                            Defaultxt = Defaultxt.Replace(results,nll.GetNodeXML(nodeid).NodeListUrl);
                        }
                    }
                    else
                    {
