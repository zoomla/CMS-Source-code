namespace ZoomLa.BLL
{
    ...
    public class B_Questions_Class
    {
        ...
        /// <returns></returns>
        public int GetInsert(M_Questions_Class questionsClass)
        {
            string sqlStr = "INSERT INTO [dbo].[ZL_Questions_Class] ([C_ClassName],[C_Classid],[C_OrderBy]) VALUES (@C_ClassName,@C_Classid,@C_OrderBy);select @@IDENTITY";
            SqlParameter[] cmdParams = initMod.GetParameters(questionsClass);
