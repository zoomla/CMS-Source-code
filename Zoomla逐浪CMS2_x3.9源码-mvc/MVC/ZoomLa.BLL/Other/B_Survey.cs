...
namespace ZoomLa.BLL
{
    ...
    public class B_Survey
    {
        ...
        public static int GetUsersCnt(int sid)
        {
            ...
            param.Value = sid;
            return SqlHelper.ObjectToInt32(SqlHelper.ExecuteScalar(CommandType.Text, strSql, param));
        }
        /// <summary>
        /// 添加提交记录
        /// </summary>
        ...
        public static bool DelQuestion(int ID)
        {
            M_Question info = new M_Question();
            return Sql.Del(info.TbName, info.PK + "=" + ID);
        }
