    ...
    public partial class Form1 : Form
    {
        ...
        */
        ...
        private void ProcesarSQL2005()
        {
            ...
            string path = Application.StartupPath + "\\Update.sql";
            try
            {
                Database origen;//来源
                Database destino;//目标
                     ...
                     (!String.IsNullOrEmpty(mySqlConnectFront2.DatabaseName))))
                {
                    ...
                    //mySqlConnectFront2.ConnectionString = @"Data Source=(LocalDB)\v11.0;AttachDbFilename=E:\Code\Code\DBDiff\ZoomlaDatga.mdf;Initial Catalog=ZoomlaDatga;Integrated Security=True;";
                    //User Instance=True;
                    //string connString = @"Data Source=(LocalDB)\v11.0;AttachDbFilename=E:\Code\Code\DBDiff\ZoomlaDatga.mdf;Initial Catalog=ZoomlaDatga;Integrated Security=True;User Instance=True;";
                    ...
                    progres.ShowDialog(this);//显示进度条,并开始逻辑
                    ...
                    txtDiferencias.Text = destino.ToSqlDiff().ToSQL();//将变更生成Sql输出至文本
                    ...
                    sw.Write(txtDiferencias.Text);
                    sw.Close();
                    //GenerateDatabase.ExecuteSQLFile(mySqlConnectFront2.ConnectionString, "D:\\ZoomLaCMS2005.sql");
                    GenerateDatabase.CreateDataBase(mySqlConnectFront2.ConnectionString, path);
                    //gs.ExecuteSql(mySqlConnectFront2.ConnectionString, sql);
        ...
        */
        ...
        private void ShowSQL2005()
        {
            ...
            ((SqlServerConnectFront)mySqlConnectFront1).ServerName = @"(LocalDB)\v11.0";//(LocalDB)\v11.0 (local)
