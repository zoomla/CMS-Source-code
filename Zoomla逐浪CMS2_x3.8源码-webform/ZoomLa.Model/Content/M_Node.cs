namespace ZoomLa.Model
{
    ...
    public class M_Node : M_Base
    {
        ...
        public M_Node() { }
        public M_Node(bool flag) { _isnull = flag; }
        public List<M_ModelInfo> ModelInfo { get; set; }
        /// <summary>
        /// 节点ID
        /// </summary>
        ...
        /// <summary>
        /// 模块类型。默认为0-站群，1为内容，2为商品，3为内容和商品，5-商城,6为互动，7为公开互动
        /// </summary>
        ...
        /// <summary>
        /// 节点转子站  null或0为节点，5为子站
        /// </summary>
        public int NodeBySite { get; set; }

        /// <summary>
        /// 当NodeBySite为5时，该字段为站点配置文件
        /// </summary>
