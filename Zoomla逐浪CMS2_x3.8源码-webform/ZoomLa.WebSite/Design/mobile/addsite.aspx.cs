...
public partial class Design_mobile_addsite : System.Web.UI.Page
{
    B_Design_MBSite mbBll = new B_Design_MBSite();
    B_User buser = new B_User();
    private int TlpID { get { return DataConvert.CLng(Request["TlpID"] ?? "1"); } }
    ...
    private void MyBind()
    {
        ...
        else//新建
        {
            ...
            if (mbMod != null) { Response.Redirect("/design/mobile/default.aspx?id=" + mbMod.ID); }
