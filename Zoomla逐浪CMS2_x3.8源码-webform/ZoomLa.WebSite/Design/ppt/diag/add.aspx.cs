...
public partial class Design_ppt_diag_add : System.Web.UI.Page
{
    ...
    private void MyBind()
    {
        ...
        {
            M_Design_Page pageMod = pptBll.SelModelByGuid(Guid);
            ...
            AccessPwd_T.Attributes["value"] = pageMod.AccessPwd;
            Add_B.Text = "保存修改";
    ...
    public void InitPage(M_Design_Page pageMod)
    {
        ...
        //默认标题
        if (string.IsNullOrEmpty(pageMod.Title)) { pageMod.Title = "我的PPT"; }
        //创建既有三个页面
