<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Design.aspx.cs" Inherits="test_design" ValidateRequest="false" MasterPageFile="~/Common/Master/Empty.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
        ...
        <div>
            ...
            <ul class="list-inline pull-right">
                ...
                <li><a href="/User/Logout.aspx"><i class="fa fa-power-off"></i> 退出</a></li>
                </ul>
            </div>
