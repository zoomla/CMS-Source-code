<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Main.aspx.cs" Inherits="MIS_ZLOA_Main" EnableViewState="false" MasterPageFile="~/MIS/OA.master" %>
                            ...
                            <div class="inContent executive">
                                <table class="myTable threeTr">
                                    ...
                                    <tr class="hover_hander">
                                        ...
                                        <td><a href="javascript:;" onclick="ShowMain('#userinfo_ul','/Mis/OA/AffairsList.aspx?view=3')">
                                            <img src="Images/Main/Receipt.gif" /><div>收文管理</div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('#userinfo_ul','/Mis/OA/Office/DocManage.aspx')">
                    ...
                    <div class="OAborder">
                        ...
                        <div class="content templatelist">
                            <div class="inContent email">
                                <table class="myTable threeTr">
                                    <tr class="hover_hander">
                                        <td><a href="javascript:;" onclick="ShowMain('Mis/OA/Mail/MailManage.aspx','/Mis/OA/Mail/MessageSend.aspx')">
                                            <img src="Images/Main/writemail.gif" /><div>写邮件</div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('Mis/OA/Mail/MailManage.aspx','/Mis/OA/Mail/Message.aspx')">
                                            <img src="Images/Main/recivemail.gif" />
                                            <div class="oa_item">
                                                收邮件<span class="item_count" runat="server" id="Span2">0</span>
                                            </div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('Mis/OA/Mail/MailManage.aspx','/Mis/OA/Mail/MessageOutbox.aspx')">
                                            <img src="Images/Main/sendmail.gif" /><div>发件箱</div>
                                        </a></td>
                                    </tr>
                                    <tr class="hover_hander">
                                        <td><a href="javascript:;" onclick="ShowMain('Mis/OA/Mail/MailManage.aspx','/Mis/OA/Mail/MessageDraftbox.aspx')">
                                            <img src="Images/Main/draftmail.gif" /><div>草稿箱</div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('Mis/OA/Mail/MailManage.aspx','/Mis/OA/Mail/MessageGarbagebox.aspx')">
                                            <img src="Images/Main/rubbishmali.gif" /><div>垃圾箱</div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('Mis/OA/Mail/MailManage.aspx','/Mis/OA/Other/StructList.aspx')">
