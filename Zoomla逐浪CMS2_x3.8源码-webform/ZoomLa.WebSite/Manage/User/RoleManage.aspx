<%@ Page Language="C#" Title="角色管理" AutoEventWireup="true" CodeFile="RoleManage.aspx.cs" Inherits="User.RoleManage" EnableEventValidation="false" EnableViewStateMac="false" MasterPageFile="~/Manage/I/Default.master" %>
