...
public partial class Manage_I_Content_Makexml : CustomerPageAction
{
    public B_SiteMap bs = new B_SiteMap();//定义一个对象 bs,继承 B_SiteMap 的方法
    ...
    public void MakeGoogleMap()
    {
        ...
        DataTable dd = bs.SelectSiteMap(num);
    ...
    public void MakeBaiduMap()
    {
        ...
        DataTable dt = bs.SelectSiteMap(num);
        Response.Write("<script>");
        StringBuilder maptxt = new StringBuilder("");
        //分类栏目
