...
public partial class Manage_Plat_AuditComp : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            MyBind();
            Call.SetBreadCrumb(Master, "<li><a href='" + CustomerPageAction.customPath2 + "I/Main.aspx'>工作台</a></li><li><a href='" + Request.RawUrl + "'>能力中心</a></li><li><a href='PlatInfoManage.aspx'>信息管理</a></li><li><a href='" + Request.RawUrl + "'>公司认证</a></li>");
        }
    }
    public void MyBind()
    {
        EGV.DataSource = ualyBll.CompCert_Sel(ZStatus);
        EGV.DataBind();
        switch (ZStatus)
        {
