...
public partial class Manage_I_Config_SiteOption : CustomerPageAction
{
    ...
    {
        if (!string.IsNullOrEmpty(ProDirName)) { function.Script(this, "showconfig('1');"); }
        ...
        if (!IsPostBack)
        {
            ...
            SiteColor_T.Text = SiteConfig.SiteOption.SiteColor;
            //---------------------
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SiteConfig.SiteOption.SiteColor = SiteColor_T.Text;
