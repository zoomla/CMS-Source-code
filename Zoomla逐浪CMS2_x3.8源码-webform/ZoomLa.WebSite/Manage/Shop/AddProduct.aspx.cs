namespace Zoomla.Website.manage.Shop
{
    ...
    public partial class AddProduct : CustomerPageAction
    {
        ...
        public void MyBind()
        {
            ...
            ProCode.Text = new B_Product().GetProCode(SiteConfig.ShopConfig.ItemRegular);
            OtherBind();//组,运费模板
            if (ProID > 0)
            {
                #region 修改
                ...
                Clearimg_t.Text = pinfo.Clearimg.ToString();
                Thumbnails_t.Text = pinfo.Thumbnails.ToString();
        ...
        protected void EBtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                proMod.ProCode =  new B_Product().GetProCode(SiteConfig.ShopConfig.ItemRegular);
            }
            ...
            proMod.Clearimg = Clearimg_t.Text;
            proMod.Thumbnails = Thumbnails_t.Text;
