...
public partial class manage_ZoneManage_ProductManage : CustomerPageAction
{
    ...
    private void GetInit()
    {
        ...
        List<blogTable> list = btbll.GetBlogTableByState(1);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!string.IsNullOrEmpty(list))
            {
                ...
                {
                    btbll.BatchUpdateState(list, int.Parse(bt.CommandName), "C");
