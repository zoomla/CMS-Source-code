...
public partial class Manage_I_ASCX_UserShopNodeTree : System.Web.UI.UserControl
{
    ...
    string noChild = "<a onclick='ShowMain(\"\",\"" + CustomerPageAction.customPath2 + "Shop/ProductManage.aspx?StoreID=-1&NodeID={0}\");'>{1}</a>";
    ...
    {
        DataTable dt = nodeBll.GetAllUserShopNode();
        nodeHtml.Text = "<ul class='tvNav'><li><a  class='list1' id='a0' onclick='ShowMain(\"\",\"" + CustomerPageAction.customPath2 + "Shop/ProductManage.aspx?StoreID=-1\");'><span class='list_span'>全部内容</span><span class='fa fa-list'></span></a>" + GetLI(dt) + "</li></ul>";
    }
}