...
public partial class Manage_I_ASCX_NodeTree : System.Web.UI.UserControl
{
    ...
    protected void BindNode()
    {
        ...
        DataTable dt = nodeBll.SelByPid(0,true);
        ...
        nodeHtml.Text = "<ul class='tvNav'><li><a  class='list1' id='a0' href='" + Url + "' target='main_right' style='padding-left:0.5em;' ><span class='list_span'>全部内容</span><span class='fa fa-list'></span></a>" + GetLI(dt) + "</li></ul>";
    }
}