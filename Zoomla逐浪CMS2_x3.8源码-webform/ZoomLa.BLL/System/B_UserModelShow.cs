...
namespace ZoomLa.BLL
{
    ...
    public class B_UserModelShow
    {
        ...
        public string GetNumberType(string Alias, string Name, bool IsNotNull, string Content, string Description, DataRow dr)
        {
            ...
            builder.Append("<input type=\"txt\" name=\"txt_" + Name + "\" id=\"txt_" + Name + "\" size=\"" + strArray2[1] + "\" value=\"" + function.HtmlEncode(dr["" + Name + ""].ToString()) + "\"> " + str2 + " " + Description + "");
            builder.Append("</td>\r\n</tr>\r\n");
            return builder.ToString();
        }
        #endregion
        ...
        public string GetTextType(string Alias, string Name, bool IsNotNull, string Content, string Description, DataRow dr)
        {
            ...
            builder.Append("<input type=\"" + strArray3[1] + "\" name=\"txt_" + Name + "\" id=\"txt_" + Name + "\" size=\"" + strArray2[1] + "\" value=\"" + function.HtmlEncode(dr["" + Name + ""].ToString()) + "\"> " + str2 + " " + Description + "");
            builder.Append("</td>\r\n</tr>\r\n");
            return builder.ToString();
        }
        #endregion
        ...
        private string GetSuperLinkType(string Alias, string Name, bool IsNotNull, string Content, string Description, DataRow dr)
        {
            ...
            builder.Append("<input type=\"text\" name=\"txt_" + Name + "\" id=\"txt_" + Name + "\" size=\"" + strArray2[1] + "\" value=\"" + function.HtmlEncode(dr["" + Name + ""].ToString()) + "\"> " + str2 + " " + Description + "");
            builder.Append("</td>\r\n</tr>\r\n");
            return builder.ToString();
        }
        #endregion
