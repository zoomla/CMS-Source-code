...
{
    public class B_AliPay_trades_Services
    {
        ...
        public B_AliPay_trades_Services(string partner,
            string seller_email,
            string return_url,
            string notify_url,
            string show_url,
        ...
        public string Build_Form()
        {
            ...
            //GET方式传递
            sbHtml.Append("<form id=\"payform\" name=\"payform\" action=\"" + gateway + "_input_charset=" + _input_charset + "\" method=\"get\" target=\"_blank\">");
