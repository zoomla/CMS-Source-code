<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cpic.aspx.cs" Inherits="ZoomLaCMS.BU.Cpic" %>
...
%>拥有此授权证书的最终解释权。</span>
                        ...
                        <div id="row4_right" style="float:right;position:relative;top:-100px;width:500px;font-size:20px;">
                            ...
                            <div style="position:absolute;top:40px;left:160px;"><img src="/App_Themes/User/sign.gif" style="width:120px;height:120px;" /></div>
