<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print.aspx.cs" Inherits="ZoomLaCMS.MIS.OA.Flow.Print" MasterPageFile="~/Common/Common.master"  ValidateRequest="false"%>
<%@ Register Src="~/Office/Tlp/receprint.ascx" TagPrefix="oa" TagName="receprint" %>
<%@ Register Src="~/Office/Tlp/sendprint.ascx" TagPrefix="oa" TagName="sendprint" %>
