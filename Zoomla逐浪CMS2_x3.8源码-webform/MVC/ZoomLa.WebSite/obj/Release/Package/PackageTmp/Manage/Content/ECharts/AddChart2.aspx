<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddChart2.aspx.cs" Inherits="ZoomLaCMS.Manage.Content.ECharts.AddChart2" MasterPageFile="~/Manage/I/Default.master" %>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel"  id="base_tb">
                        <table class="table table-bordered table-striped">
                           ...
                           <tr><td>主标题超链接:</td><td><asp:TextBox runat="server" CssClass="form-control text_300" ID="Link_T" Text="www.z01.com" /></td></tr>
