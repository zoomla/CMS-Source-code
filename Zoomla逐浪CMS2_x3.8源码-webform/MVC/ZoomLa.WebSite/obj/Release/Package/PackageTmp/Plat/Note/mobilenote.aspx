<%@ Page Language="C#" MasterPageFile="~/Common/Master/Empty.master" AutoEventWireup="true" CodeBehind="mobilenote.aspx.cs" Inherits="ZoomLaCMS.Plat.Note.mobilenote" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
        ...
        <div ng-controller="NoteCtrl">
            ...
            <div class="mnote_top">
                <div class="mnote_top_c">
                    <div class="mnote_top_t" ng-style="{'background':'url({{comMod.topimg}}) center no-repeat','background-size':'cover'}">
                        <div ng-if="comMod.topimg==''" class="mnote_top_ti"><i class="fa fa-image"></i>
                            <br />
                            背景图片</div>
                    </div>
                    <div class="mnote_top_b">
                        <input type="text" class="form-control" placeholder="添加标题" ng-model="comMod.title" /></div>
                </div>
            </div>
            <!--mnote_top end-->
                ...
                <div class="con_item" ng-repeat="item in comMod.comlist |orderBy: 'orderID'" ng-switch="item.type">
                    ...
                    <div ng-switch-when="para" class="com com_para">
                        <div id="{{item.id}}_div" class="paralist_item {{item.content}}">
                            <img ng-src="/plat/note/res/{{item.content}}.gif" />
    ...
    <div id="paralist" class="paralist_div">
        <ul class="list-unstyled paralist_ul">
            <li>
                <img data-class="t1" src="/plat/note/res/ps1.gif" />
            </li>
            <li>
                <img data-class="t2" src="/plat/note/res/ps2.gif" />
            </li>
            <li>
                <img data-class="t3" src="/plat/note/res/ps3.gif" />
            </li>
            <li>
                <img data-class="t4" src="/plat/note/res/ps4.gif" />
            </li>
            <li>
                <img data-class="t5" src="/plat/note/res/ps5.gif" />
            </li>
        </ul>
    </div>
    <div class="hidden">
    ...
    <script>
        ...
        $(function () {
            ...
            $("#paralist img").click(function () {
                ...
                $("#" + id + "_div img").attr('src', "/plat/note/res/" + $(this).data('class') + ".gif");
