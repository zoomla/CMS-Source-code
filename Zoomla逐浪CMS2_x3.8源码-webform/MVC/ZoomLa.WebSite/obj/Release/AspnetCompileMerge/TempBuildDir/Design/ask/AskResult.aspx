<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AskResult.aspx.cs" Inherits="ZoomLaCMS.Design.ask.AskResult" MasterPageFile="~/Common/Master/Ionic.master" %>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">
                    <img alt="<%Call.Label("{$SiteName/}");%>" src="<%Call.Label("{$LogoUrl/}");%>" /></a>
            </div>
...
<div class="bar bar-header bar-balanced navbar-fixed-top visible-xs">
    ...
    <a href="default.aspx#/tab/ask_view/<%:Mid %>" class="button"><i class="fa fa-send"></i></a>
</div>
<div class="askres_main">
    ...
    <div class="container padding0-xs">
        <div class="design_askimg">
            <img src="" alt="" onerror="javascript:this.src='/UploadFiles/timg.jpg';" id="ask_img" runat="server" /></div>
        <div class="list">
...
<div class="h44"></div>
<div class="ask_tips">
    <span>创建于<asp:Label ID="CDate_L" runat="server"></asp:Label>
        将于<asp:Label ID="EndDate_L" runat="server"></asp:Label>到期</span>
