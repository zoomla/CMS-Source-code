<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sensitivity.aspx.cs"  MasterPageFile="~/Manage/I/Default.master" Inherits="ZoomLaCMS.Manage.Config.Sensitivity" %>
