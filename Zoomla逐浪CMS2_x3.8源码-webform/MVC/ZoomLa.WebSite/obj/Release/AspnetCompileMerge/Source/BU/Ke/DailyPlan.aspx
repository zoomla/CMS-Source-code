<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyPlan.aspx.cs" Inherits="ZoomLaCMS.MIS.Ke.DailyPlan"  masterpagefile="~/Plat/Main.master" %>
...
<script>
    ...
    $(function () {
        ...
        $("#DateBody .datas").dblclick(function () {
            ShowComDiag("/BU/Ke/DailyPlan_Add.aspx?TypeID=<%=TypeID %>", "添加日程");
        });
        //日程列表
