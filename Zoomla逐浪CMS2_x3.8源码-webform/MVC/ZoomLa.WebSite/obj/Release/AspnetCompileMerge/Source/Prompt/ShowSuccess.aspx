<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowSuccess.aspx.cs" Inherits="ZoomLaCMS.Prompt.ShowSuccess" EnableViewStateMac="false" ValidateRequest="false" MasterPageFile="~/Common/Master/Empty.master"%>
    ...
    <div class="panel panel-primary" style="width: 400px; margin: auto; margin-top: 12%;">
            ...
            <div class="panel-body text-center">
             ...
             <div class="panel-footer" style="text-align:center;">
                <asp:HyperLink ID="LnkReturnUrl" runat="server" class="btn btn-primary"><span class="fa fa-repeat"></span> 返回上一页</asp:HyperLink>
            </div>
        </div>
        <script>
