<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddWorks.aspx.cs" Inherits="ZoomLaCMS.Manage.Copyright.AddWorks" ValidateRequest="false" MasterPageFile="~/Manage/I/Default.master" %>
