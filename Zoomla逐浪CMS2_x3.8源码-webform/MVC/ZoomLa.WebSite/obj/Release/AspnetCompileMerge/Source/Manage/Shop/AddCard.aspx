    ...
    <div>
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td>&nbsp;
          <asp:TextBox ID="num" class="form-control td_l" runat="server" Text="10"></asp:TextBox></td>
            </tr>
            <tr>
                <td>卡号编码类型： </td>
                <td>
          ...
          <asp:TextBox ID="endtime" class="form-control td_l" runat="server" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox>
            ...
            <tr>
                ...
                <td>&nbsp;
            <label>
                <input type="radio" name="isopen" value="1" />停用</label>
                    <label>
                        <input type="radio" name="isopen" value="2" checked="checked" />启用</label></td>
            </tr>
            <tr>
                <td><strong></strong></td>
                <td>
                    <asp:Button ID="Button1" class="btn btn-primary" Style="width: 110px;" runat="server" Text="开始生成" OnClick="Button1_Click" /></td>
            </tr>
        </table>
    </div>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        $("#createtime_T").change(function () {
            var cdate = new Date($(this).val());
            console.log(cdate.getYear() + 1, cdate.setYear(cdate.getYear() + 1));
            $("#endtime").val(cdate.setYear(cdate.getYear() + 1));
        });
    </script>
</asp:Content>
