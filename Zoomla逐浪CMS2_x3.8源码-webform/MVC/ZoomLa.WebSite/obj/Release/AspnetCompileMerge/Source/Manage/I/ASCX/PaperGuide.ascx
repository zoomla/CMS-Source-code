<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaperGuide.ascx.cs" Inherits="ZoomLaCMS.Manage.I.ASCX.PaperGuide" %>
<div id="nodeNav" style="padding: 0 0 0 0;">
    <div class="input-group">
        ...
        <span class="input-group-btn">
            <button class="btn btn-default" type="button" onclick="ASCX.Search('<%:CustomerPageAction.customPath2+"Exam/Papers_System_Manage.aspx?keyWord=" %>','keyWord');"><span class="fa fa-search"></span></button>
        </span>
    </div>
    <div>
        <div class="tvNavDiv">
