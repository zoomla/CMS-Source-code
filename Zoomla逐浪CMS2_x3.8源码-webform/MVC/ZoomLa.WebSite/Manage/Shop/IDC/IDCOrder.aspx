        ...
        <%--      <td>金额</td>--%>
            ...
            <ZL:ExRepeater runat="server" ID="RPT" OnItemCommand="RPT_ItemCommand" BoxType="dp"
             ...
             <%--           <td><%#Eval("OrdersAmount","{0:f2}")%></td>--%>
                        ...
                        <td>
                            <a href="javascript:;" title="详情" class="option_style" onclick="openinfo('订单详记','<%#Eval("ID") %>','message');"><i class="fa fa-sticky-note-o"></i>详记</a>
                            <a href="javascript:;" title="内注" class="option_style" onclick="openinfo('订单内注','<%#Eval("ID") %>','record');"><i class="fa fa-pencil"></i>内注</a>
                            <%#GetOP() %>
