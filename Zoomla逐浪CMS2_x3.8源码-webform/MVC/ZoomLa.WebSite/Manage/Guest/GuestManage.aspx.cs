namespace ZoomLaCMS.Manage.Guest
{
    ...
    using ZoomLa.Model;
    using System.IO;
    public partial class GuestManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                MyBind();
                Call.SetBreadCrumb(Master, "<li><a href='" + CustomerPageAction.customPath2 + "I/Main.aspx" + "'>工作台</a></li><li class='active'><a href='/admin/Guest/GuestManage.aspx'>留言管理</a></li><li class='active'>[<a href='javascript:;' onclick='ShowCate(0,0);' id='showDiv'>添加留言分类</a>]</li>" + Call.GetHelp(92));
            }
        }
        private void MyBind()
        {
        ...
        {
            return StringHelper.GetItemIcon(Eval("BarImage").ToString(), "width:30px;height:30px;");
        }
    }
}