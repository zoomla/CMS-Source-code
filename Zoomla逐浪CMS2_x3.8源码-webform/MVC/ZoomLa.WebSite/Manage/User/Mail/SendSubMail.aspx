<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendSubMail.aspx.cs" Inherits="ZoomLaCMS.Manage.User.Mail.SendSubMail" ValidateRequest="false" MasterPageFile="~/Manage/I/Default.master" %>
