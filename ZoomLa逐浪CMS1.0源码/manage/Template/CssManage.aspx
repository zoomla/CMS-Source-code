<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CssManage.aspx.cs" Inherits="ZoomLa.WebSite.Manage.Template.CssManage" %>
...
<body>
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span>&gt;&gt;<span>系统设置</span> &gt;&gt;<span>风格管理</span>
	</div>
    ...
    <ItemTemplate>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">            
            <td align="left">
				...
				<a href="<%# System.Convert.ToInt32(Eval("type")) == 1 ?  "CssManage.aspx?Dir=" + Server.UrlEncode(Request.QueryString["Dir"] +"/"+ Eval("Name").ToString()):"CssEdit.aspx?filepath="+ Server.UrlEncode(Request.QueryString["Dir"] +"/"+ Eval("Name").ToString()) %>">
				<%# Eval("Name") %></a>
			</td>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" align="center">
        <tr class="tdbg">
			<td width="10%" align="center"><asp:Button ID="Button1" runat="server" Text="新建风格"  OnClick="Button1_Click" /></td>
			...
			<td width="10%"><asp:Button ID="btnTemplateUpLoad" runat="server" Text="上传风格" OnClick="btnTemplateUpLoad_Click"  /></td>
		</tr>
    </table>
    </form>
</body>
