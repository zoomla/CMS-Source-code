<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditNode.aspx.cs" Inherits="ZommLa.WebSite.Manage.Content.EditNode" %>
            ...
            <%-- 基本信息--%>
                    <tbody id="Tabs0">
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="TxtNodeName" runat="server" Columns="30"></asp:TextBox>
