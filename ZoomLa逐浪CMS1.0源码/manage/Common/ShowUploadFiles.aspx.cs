...
{
    public partial class ShowUploadFiles : System.Web.UI.Page
    {
        ...
        protected void RptFiles_ItemCommand(object source, CommandEventArgs e)
        {
            ...
            if (e.CommandName == "DelDir")
            {
                ...
                AdminPage.WriteSuccessMsg("<li>目录成功删除</li>", "FileManage.aspx?Dir=" + base.Server.UrlEncode(base.Request.QueryString["Dir"]));
            }
        }
    }
