...
namespace ZoomLa.BLL.WxPayAPI
{
    public class WxPayApi
    {
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj, M_WX_APPID appMod, int timeOut = 6)
        {
        ...
        */
        public static WxPayData Refund(WxPayData inputObj, M_WX_APPID appMod, int timeOut = 6)
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static WxPayData RefundQuery(WxPayData inputObj, M_WX_APPID appMod, int timeOut = 6)
        {
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData DownloadBill(WxPayData inputObj, M_WX_APPID appMod, int timeOut = 6)
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static WxPayData ShortUrl(WxPayData inputObj, M_WX_APPID appMod, int timeOut = 6)
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static WxPayData CloseOrder(WxPayData inputObj, M_WX_APPID appMod, int timeOut = 6)
        {
        ...
        */
        ...
        /// </summary>
        /// <returns></returns>
        public static WxPayData Transfer(WxPayData inputObj, M_WX_APPID appMod)
        {
            ...
            //inputObj.SetValue("re_user_name", "徐林之");
            //inputObj.SetValue("amount", "100");
            //inputObj.SetValue("desc", "提现");
            //inputObj.SetValue("spbill_create_ip", "58.215.65.54");

            inputObj.SetValue("mch_appid", appMod.Pay_APPID);//公众帐号ID
            inputObj.SetValue("mchid", appMod.Pay_AccountID);//商户号
            inputObj.SetValue("nonce_str", Guid.NewGuid().ToString().Replace("-", ""));//随机字符串
            inputObj.SetValue("sign", inputObj.MakeSign());//签名

            string xml = inputObj.ToXml();
            string response = HttpService.Post(xml, url, true, 6,appMod);
            WxPayData result = new WxPayData();
            result.FromXml(response);
            return result;
        }
