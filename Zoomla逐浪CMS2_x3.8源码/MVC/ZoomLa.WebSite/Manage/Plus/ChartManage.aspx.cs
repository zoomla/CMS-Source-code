...
{
    public partial class ChartManage : CustomerPageAction
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Call.SetBreadCrumb(Master, "<li><a href='" + CustomerPageAction.customPath2 + "Main.aspx'>工作台</a></li><li><a href='" + customPath2 + "Plus/ADManage.aspx'>广告管理</a></li><li class='active'><a href='ChartManage.aspx'>图表管理</a>  <a href='../Content/ECharts/AddChart.aspx'>[添加图表]</a></li>" + Call.GetHelp(32));
        }
