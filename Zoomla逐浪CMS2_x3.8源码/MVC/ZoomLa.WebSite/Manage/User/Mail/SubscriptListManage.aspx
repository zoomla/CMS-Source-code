<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubscriptListManage.aspx.cs" Inherits="ZoomLaCMS.Manage.User.Mail.SubscriptListManage"  MasterPageFile="~/Manage/I/Default.master" %>
