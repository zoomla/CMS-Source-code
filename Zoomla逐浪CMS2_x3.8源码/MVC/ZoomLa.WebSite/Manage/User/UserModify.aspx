        ...
        <div class="tab-pane active" id="Tabs0">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td class="text-left">
                        <asp:TextBox ID="tbNewPwd" runat="server" onkeydown="return GetEnterCode('focus','tbConPwd');" class="form-control text_md"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="text-left">
                        <asp:TextBox ID="tbConPwd" runat="server" onkeydown="return GetEnterCode('focus','tbEmail');" class="form-control" Style="max-width: 200px;"></asp:TextBox>
        ...
        <div class="tab-pane" id="Tabs1">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td style="width: 15%; height: 26px;" class="text-right">头像选择：</td>
        ...
        <div class="tab-pane" id="Tabs4">
            <table class="table table-striped table-bordered table-hover">
                <tr>
                    ...
                    <td valign="top"><asp:CheckBoxList ID="cblRoleList" runat="server" /></td>
                </tr>
            </table>
        </div>
    </div>
...
$(function () {
    ...
    console.log($("[href='#<%=Request.QueryString["tabs"] %>']").length);
    //---------------------
