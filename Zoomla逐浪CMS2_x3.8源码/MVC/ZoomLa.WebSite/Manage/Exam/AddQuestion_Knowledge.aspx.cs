namespace ZoomLaCMS.Manage.Exam
{
    ...
    using ZoomLa.BLL;
    using ZoomLa.Model;
    public partial class AddQuestion_Knowledge : System.Web.UI.Page
    {
        B_Exam_Class bqc;
        B_ExamPoint bqk;
        ...
        protected void EBtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["menu"] != null && Request.QueryString["menu"] != "")
            {
                ...
                if (menu.Equals("Edit")) //修改知识点
                {
                    ...
                    if (result)
                    {
                        function.WriteSuccessMsg("修改成功!", "Questions_Knowledge_Show.aspx?c_id=" + mqk1.TID);
                    }
                    else
                    {
                ...
                if (menu.Equals("Add"))  //添加知识点
                {
                    ...
                    if (result > 0)
                    {
                        function.WriteSuccessMsg("添加成功!", "Questions_Knowledge_Show.aspx?c_id=" + mqk1.TID);
                    }
                    else
                    {
