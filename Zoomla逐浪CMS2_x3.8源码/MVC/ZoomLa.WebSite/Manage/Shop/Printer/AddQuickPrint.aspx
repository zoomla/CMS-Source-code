<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddQuickPrint.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.Printer.AddQuickPrint"MasterPageFile="~/Manage/I/Default.master" %>
