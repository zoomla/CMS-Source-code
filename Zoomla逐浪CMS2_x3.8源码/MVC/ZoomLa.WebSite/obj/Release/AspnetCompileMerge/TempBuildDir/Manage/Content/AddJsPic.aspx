<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddJsPic.aspx.cs" Inherits="ZoomLaCMS.Manage.Content.AddJsPic" MasterPageFile="~/Manage/I/Default.master" %>
...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="table table-striped table-bordered table-hover" align="center">
	...
	<tr>
		...
		<td>
			<asp:RadioButtonList ID="ContentType_Rad" runat="server" RepeatDirection="Horizontal">
	...
	<tr>
		...
		<td>
			<asp:TextBox ID="JsFileName" runat="server" Width="270px" CssClass="form-control pull-left" onfocus="AddJs('JsName','JsFileName','ContentType_Rad')"></asp:TextBox>
