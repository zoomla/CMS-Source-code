<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDevice.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.Printer.AddDevice"  MasterPageFile="~/Manage/I/Default.master" %>
