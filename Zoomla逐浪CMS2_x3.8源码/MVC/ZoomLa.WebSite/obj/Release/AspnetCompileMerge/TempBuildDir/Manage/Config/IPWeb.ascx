<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IPWeb.ascx.cs" Inherits="ZoomLaCMS.Manage.Config.IPWeb" %>
<div style="width: 420px" runat="server">
    <asp:Panel ID="Panel1" runat="server" Width="100%">
        <ZL:ExGridView ID="EgvIPLock" PageSize="20" runat="server" Width="100%" OnRowDeleting="EgvIPLock_RowDeleting" AutoGenerateColumns="False">
                <Columns>
