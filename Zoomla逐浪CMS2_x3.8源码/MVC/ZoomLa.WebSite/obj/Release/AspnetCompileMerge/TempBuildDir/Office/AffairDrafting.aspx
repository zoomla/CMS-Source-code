<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AffairDrafting.aspx.cs" Inherits="ZoomLaCMS.MIS.OA.AffairDrafting"  MasterPageFile="~/Common/Master/UserEmpty.master"  ValidateRequest="false"%>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
        <div class="draftnav">
            <a href="/Office/Main.aspx">行政公文</a>/<a href="AffairDrafting.aspx">行政办公起草</a>
        </div>
        ...
        <div id="select" style="position: absolute; display: none; width: 800px; background: #FFF; border: 1px solid #ddd; top: 20%; left: 20%; z-index: 99999;">
            <div id="Free_Div" runat="server" class="panel panel-primary">
                ...
                <div class="panel-body">
                    <iframe runat="server" id="User_IFrame" style="visibility: inherit; overflow: auto; overflow-x: hidden; width: 800px; height: 420px;" name="main_right" src="/Office/Mail/SelGroup.aspx?Type=AllInfo" frameborder="0"></iframe>
                </div>
            </div>
        </div>
        ...
        function selRuser() {
            ...
            $("#User_IFrame").attr("src", "/Office/Mail/SelGroup.aspx?Type=AllInfo#ReferUser");
        ...
        {
            $("#select").css("margin-top", $(document).scrollTop());
            $("#User_IFrame").attr("src", "/Office/Mail/SelGroup.aspx?Type=AllInfo#CCUser");
            $("#User_IFrame")[0].contentWindow.ClearChk();
            $("#select").show();
        }
