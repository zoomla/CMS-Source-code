...
function swiperAnimate(a) {
    ...
    for (i = 0; i < b.length; i++)
    {
        ...
        count = b[i].attributes["swiper-animate-count"] ? b[i].attributes["swiper-animate-count"].value : "",
        count && (style = style + "animation-count:" + count + ";-webkit-animation-iteration-count:" + count + ";"),
