<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MessageGarbagebox.aspx.cs" Inherits="ZoomLaCMS.Plat.Mail.MessageGarbagebox"  MasterPageFile="~/Plat/Main.master"  ValidateRequest="false"%>
...
<%--    <div class="container-fluid">
    ...
    <div class="us_seta" style="margin-top: 5px;">
      ...
      <asp:Button ID="Button3" runat="server" Text="批量删除" OnClick="Button2_Click" class="btn btn-info" OnClientClick="return confirm('确定要彻底删除选定邮件吗!!');"/>
      <asp:Button id="Button4" runat="server" Text="批量还原" OnClick="Button4_Click" class="btn btn-info" />
    </div>
  </div>
</asp:Content>
