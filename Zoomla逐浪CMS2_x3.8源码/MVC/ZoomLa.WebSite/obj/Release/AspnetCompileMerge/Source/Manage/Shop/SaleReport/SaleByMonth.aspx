<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaleByMonth.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.SaleReport.SaleByMonth" MasterPageFile="~/Manage/I/Default.Master" %>
...
<div id="BreadDiv" class="container-fluid" style="height:10px;">
	...
	<ol id="BreadNav" class="breadcrumb navbar-fixed-top">
        ...
        <li><a href="TotalSale.aspx">按月销售统计</a></li>
        ...
        <div id="sel_box">
            <div class="input-group" style="display: inline-block;">
                <asp:TextBox runat="server" ID="SDate_T" class="form-control text_md" placeholder="起始时间" onclick="WdatePicker({ dateFmt: 'yyyy/MM' });" />
                <asp:TextBox runat="server" ID="EDate_T" class="form-control text_md" placeholder="起始时间" onclick="WdatePicker({ dateFmt: 'yyyy/MM' });" />
