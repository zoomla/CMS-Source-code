<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Producer.aspx.cs" Inherits="ZoomLaCMS.Manage.UserShopMannger.Producer" ValidateRequest="false" MasterPageFile="~/Manage/I/Default.master" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td valign="middle">
                ...
                <asp:HiddenField ID="ID_Hid" runat="server" />
