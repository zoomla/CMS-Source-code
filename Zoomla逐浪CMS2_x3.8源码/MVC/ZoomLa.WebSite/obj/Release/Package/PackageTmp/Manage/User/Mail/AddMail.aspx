<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddMail.aspx.cs" Inherits="ZoomLaCMS.Manage.User.Mail.AddMail" ValidateRequest="false" MasterPageFile="~/Manage/I/Default.master" %>
