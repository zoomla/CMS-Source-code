<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="ZoomLaCMS.Design.ppt.diag.add" MasterPageFile="~/Common/Master/Empty.master" %>
...
<div class="mbh5_create" style="overflow:hidden;">
    ...
    <div class="mbh5_create_c">
        <div class="weui_cells weui_cells_form">
            <div class="weui_cell">
                <div class="weui_cell_hd">
                    <label class="weui_label">名称</label></div>
                <div class="weui_cell_bd weui_cell_primary">
                    <ZL:TextBox runat="server" ID="Title_T" CssClass="form-control input-sm" AllowEmpty="false" ValidType="String" Text="我的PPT" placeholder="PPT名称" />
                </div>
            </div>
            <div class="weui_cell">
                <div class="weui_cell_hd">
                    <label class="weui_label">访问密码</label></div>
                <div class="weui_cell_bd weui_cell_primary">
                    <asp:TextBox runat="server" ID="AccessPwd_T" TextMode="Password" CssClass="form-control input-sm" placeholder="访问密码" />
                </div>
            </div>
        </div>
        <div class="weui_cell bgcolor_div">
            <div class="weui_cell_hd">
                <label class="weui_label">背景</label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <div class="con">
        ...
        <div class="weui_cell">
            <div class="weui_cell_hd">
                <label class="weui_label">图标</label></div>
            <div class="weui_cell_bd weui_cell_primary">
...
<div class="mbh5_create_b">
    <asp:Button runat="server" ID="Add_B" Text="创建新PPT" OnClick="Add_B_Click" CssClass="btn btn-danger btn-block btn-lg" />
    <a href="/Class_371/Default.aspx" class="btn btn-info btn-block mb_btn">【从已建立的PPT中选择一个美化设计】</a>
...
function showinpc() {
    $(".mb_btn").hide();
    $(".form-control").removeClass("input-sm").css("width", 373);
