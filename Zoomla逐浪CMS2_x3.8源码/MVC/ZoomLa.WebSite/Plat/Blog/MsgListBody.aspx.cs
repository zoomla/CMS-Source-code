        ...
        public string ShowLikeUser()
        {
            ...
            if (LikesDt != null)
            {
                ...
                foreach (DataRow dr in dt.DefaultView.ToTable().Rows)
                {
                    ...
                    result += "<li title='" + name + "' data-uid='" + dr["CUser"] + "' class='likeids_li'><a href='javascript:ShowUser(" + dr["CUser"] + ");'><div class=\"uword uword_xs\">" + uword + "</div><img src='" + dr["salt"] + "' class=\"uimg img_xs\" onerror=\"showword(this);\" data-uid=\"" + Eval("CUser") + "\"/></a></li>";
                }
            }
            return result;
        }
