  ...
  (function(factory) {
    ...
    Controller = (function() {
      ...
      Controller.prototype.init = function(setting) {
        ...
        this.view.init();
        return this.model.reload(this.setting.data);//初始化加载数据
      };
      ...
      Controller.prototype.trigger = function (name, data) {//获取@之后的值
        var alias, event_name;
        data.push(this);
        alias = this.get_opt('alias');
        event_name = alias ? "" + name + "-" + alias + ".atwho" : "" + name + ".atwho";
        return this.$inputor.trigger(event_name, data);//matched.atwho,reposition.atwho两种事件,$inputor为MsgContent_T 
      };
      ...
      Controller.prototype.get_range = function () {
          ...
          //changed by FuzhePan :解决IE10中  IndexSizeError 脚本错误。
          //return this.range || (window.getSelection ? window.getSelection().getRangeAt(0) : void 0);
          return this.range || (window.getSelection && window.getSelection().rangeCount > 0 ? window.getSelection().getRangeAt(0) : void 0);
      };
      ...
      Controller.prototype.insert_content_for = function ($li) {//点击后，往文本框中插入内容触发该方法
      ...
      Controller.prototype.look_up = function() {
        ...
        _callback = function(data) {
          //if (data && data.length > 0) {
            return this.render_view(data);//json
          //} else {
    ...
    View = (function() {
        ...
        this.context = context;
        this.$el = $("<div class='atwho-view'><div class='atwho-title'></div><ul class='atwho-view-ul'></ul></div>");
      ...
      View.prototype.init = function() {
        var id;
        var title = this.context.get_opt("title");
        id = this.context.get_opt("alias") || this.context.at.charCodeAt(0);
        this.$el.children('.atwho-title').text(title);
        this.$el.attr({'id': "at-view-" + id });
        return this;
      };
      ...
      View.prototype.visible = function() {
        return this.$el.is(":visible") && this.$el.find('ul').children('li').length > 0;
      };

      View.prototype.choose = function() {//选中之后触发
        var $li, content;
        $li = this.$el.find(".cur");
      ...
      View.prototype.reposition = function (rect) {//Object {left: 10, top: 116, bottom: 131} 
        var offset;
      ...
      View.prototype.render = function(list) {//绘制成员,清空ul后重新填数据
        ...
        for (_i = 0, _len = list.length; _i < _len; _i++) {
          ...
          li = this.context.callbacks("tpl_eval").call(this.context, tpl, item);//替换模板中的值
