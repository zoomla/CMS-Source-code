namespace Zoomla.Website.manage.UserShopManage
{
    ...
    public partial class ProducerManage : CustomerPageAction
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Call.SetBreadCrumb(Master, "<li><a href='" + CustomerPageAction.customPath2 + "Main.aspx'>工作台</a></li><li><a href='StoreManage.aspx'>店铺管理</a><li class='active'>厂商管理<a href='Producer.aspx'>[添加厂商]</a></li>");
        }
