...
<table class="table table-striped table-bordered table-hover">
	<tbody>
        ...
        <tr><td>
            <strong>网站配色：</strong></td>
            <td>
                <asp:TextBox runat="server" ID="SiteColor_T" CssClass="form-control text_300"/>
                <span class="rd_green">#428bca为初始配色</span>
            </td>
        </tr>
		<tr>
...
$(function () {
    ...
    $("#SiteColor_T").ColorPickerSliders({
        placement: 'right',
        hsvpanel: true,
        previewformat: 'hex',
        size:"sm",
