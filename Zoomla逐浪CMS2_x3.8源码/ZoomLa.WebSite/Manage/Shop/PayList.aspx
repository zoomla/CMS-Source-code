<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayList.aspx.cs" Inherits="Zoomla.Website.manage.Shop.PayList" EnableViewStateMac="false" MasterPageFile="~/Manage/I/Default.master" %>
                ...
                <ItemTemplate>
                    <tr ondblclick="location.href='../Pay/DepostDetail.aspx?ztype=pay&ID=<%#Eval("PaymentID") %>';">
                        ...
                        <td>
                            ...
                            <a href="../Pay/DepostDetail.aspx?ztype=pay&ID=<%#Eval("PaymentID") %>" class="option_style"><i class="fa fa-globe" title="浏览"></i>浏览</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
