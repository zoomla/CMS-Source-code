<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" EnableEventValidation="false" CodeFile="AddProduct.aspx.cs" Inherits="Zoomla.Website.manage.Shop.AddProduct" EnableViewStateMac="false" MasterPageFile="~/Manage/I/Default.master" %>
        ...
        <table class="table table-striped table-bordered">
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="Clearimg_t" runat="server" class="form-control text_300" />
                    ...
                    <tr id="addsmallimg">
                        ...
                        <td>
                            <asp:TextBox ID="Thumbnails_t" runat="server" class="form-control text_300" />
