<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionManage2.aspx.cs" Inherits="User_Exam_QuestionManage2" EnableViewStateMac="false" MasterPageFile="~/Common/Common.master"%>
...
<style type="text/css">
    * {font-family:'Microsoft YaHei';font-size:12px;}
    ...
    src: url('http://code.z01.com/font/ZoomlaXingtiJ2.eot?#iefix'); /* IE9 */
    src: url('http://code.z01.com/font/ZoomlaXingtiJ2.eot?#iefix') format("embedded-opentype"), /* IE6-IE8 */
    url('http://code.z01.com/font/ZoomlaXingtiJ2.woff') format("woff"), /* chrome、firefox */
    url('http://code.z01.com/font/ZoomlaXingtiJ2.ttf') format("truetype"), /* chrome、firefox、opera、Safari, Android, iOS 4.2+ */
    url('http://code.z01.com/font/ZoomlaXingtiJ2.svg#ZoomlaXingtiJ') format("svg"); /* iOS 4.1- */
