 ...
 */ 
public partial class Design_Diag_AddComp : System.Web.UI.Page
{
    //需要展示的组件类型
    ...
    private DataTable GetCateByType(string stype) 
    {
        ...
        {
            case "mobile":
                compArr = "基础:mb_basic,展示:mb_view,高级:mb_adv";
                break;
            case "ipad":
                break;
            case "scence":
            default:
                compArr = "文字:text,布局:div,图文:ueditor,按钮:button,图片:image,数据:list,相册:gallery,菜单:menu,";
