<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Design_SPage_Default" MasterPageFile="~/Common/Master/Empty2.Master" EnableViewState="false" ValidateRequest="false" %>
...
<nav class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          <a class="navbar-brand" href="javascript:;" onclick="scope.showDiag('AddPage.aspx','添加新页');"><i class="fa fa-file"></i> 添加新页</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <li><a href="javascript:;" onclick="scope.showDiag('AddPage.aspx?id=<%:pageMod.ID %>','页面配置',true);"><i class="fa fa-file-archive-o"></i> 页面配置</a></li>
            <li><a href="PageDesign.aspx?ID=<%:pageMod.ID %>"><i class="fa fa-pencil"></i> 页面设计</a></li>
            <li><a href="PreView.aspx?ID=<%:pageMod.ID %>"><i class="fa fa-globe"></i> 预览页面</a></li>
...
#editor .layout .btnwrap {position: absolute; left: -1px; top: -30px; height: 30px; padding: 3px; border: 1px solid #ddd; border-bottom: none; }
...
var scope = null;
    ...
    $scope.Comp.datas["content"]={name:"自定义内容",data:{value:"<div>请输入内容</div>"},config:{style:"",width:"container" }};
    ...
    var html="<button type=\"button\" class=\"btn btn-info\" ng-click=\"showAddComp(list)\"><i class=\"fa fa-plus\"></i></button>"
+"<button type=\"button\" class=\"btn btn-info\" ng-click=\"Comp.del(list,comp);\"><i class=\"fa fa-trash-o\"></i></button>"
+"<button type=\"button\" class=\"btn btn-info\" ng-disabled=\"!Comp.canmove(comp,'pre',list)\" ng-click=\"Comp.move(comp,'pre',layout.middle);\"><i class=\"fa fa-chevron-up\"></i></button>"
+"<button type=\"button\" class=\"btn btn-info\" ng-disabled=\"!Comp.canmove(comp,'next',list)\" ng-click=\"Comp.move(comp,'next',layout.middle);\"><i class=\"fa fa-chevron-down\"></i></button>";
    return {
        restrict: 'E',
        replace: true,
