...
public partial class Plat_Blog_SpecBody : System.Web.UI.Page
{
    B_Plat_Topic topicBll = new B_Plat_Topic();
    M_User_Plat upMod = null;
    B_User buser = new B_User();
    private int CPage { get { return PageCommon.GetCPage(); } }
    private int PSize { get { return DataConverter.CLng(Request.Form["psize"]); } }
    private string Filter { get { return Request.Form["filter"].Trim(); } }
