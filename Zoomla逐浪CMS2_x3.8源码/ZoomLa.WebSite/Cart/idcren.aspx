<%@ Page Language="C#" AutoEventWireup="true" CodeFile="idcren.aspx.cs" Inherits="Cart_idcren" MasterPageFile="~/Cart/order.master" %>
...
<tr><td class="td_m">续费订单</td><td><asp:Label runat="server" ID="OrderNo_L"></asp:Label></td></tr>
<tr><td>绑定域名</td><td><asp:Label runat="server" ID="Domain_L"></asp:Label></td></tr>
<tr><td>产品名称</td><td><asp:Label runat="server" ID="Proname_L"></asp:Label></td></tr>
<tr><td>到期时限</td><td><asp:Label runat="server" ID="ETime_L"></asp:Label></td></tr>
