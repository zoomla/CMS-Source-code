...
public partial class Common_SelKeyWords : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            function.WriteErrMsg("您还没有登录!请点击[<a href='/User/Login.aspx'>登录</a>]","/User/Login.aspx");
        }
        if (!IsPostBack)
        {
            MyBind();
    ...
    {
        DataTable dt = keyBll.SelAll(KeyType,search);
        EGV.DataSource = dt;
        EGV.DataBind();
    }
