...
public partial class Common_Label_DownFile : System.Web.UI.Page
{
    ...
    public void DownFile(int gid, string field)
    {
        ...
        if (dt.Columns.Contains(field))
        {
            ...
            {
                if (mu.IsNull || mu.UserID < 1) { function.WriteErrMsg("该文件必须登录后才可下载,<a href='/User/Login.aspx'>点击登录</a>"); return; }
