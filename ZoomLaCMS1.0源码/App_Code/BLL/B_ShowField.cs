...
namespace ZoomLa.BLL
{
    ...
    public class B_ShowField
    {
        ...
        public string GetFileType(string Alias, string Name, bool IsNotNull, string Content, string Description, int ModelID, int NodeID, DataRow dr)
        {
            ...
            str = str + "<iframe id=\"Upload_" + Name + "\" src=\"../Common/FileUpload.aspx?ModelID=" + ModelID + "&FieldName=" + Name + "&NodeId=" + NodeID + "\" marginheight=\"0\" marginwidth=\"0\" frameborder=\"0\" width=\"100%\" height=\"30\" scrolling=\"no\"></iframe></td>\r\n</tr>";
            if (IsNotNull)
            {
                str2 = "<font color=\"red\">*</font>";
            }
            ...
            builder.Append("<input type=\"button\" class=\"button\" onclick=\"SelectFile('sel_" + Name + "','txt_" + Name + "')\" value=\"从上传文件中选择\"> <br/>");
        ...
        public string GetPicType(string Alias, string Name, bool IsNotNull, string Content, string Description, int ModelID, int NodeID, DataRow dr)
        {
            ...
            if (dr == null)
            {
                ...
                builder.Append("<tr class='tdbg'>\r\n<td><iframe id=\"Upload_" + Name + "\" src=\"../Common/FileUpload.aspx?ModelID=" + ModelID + "&FieldName=" + Name + "&NodeId=" + NodeID + "\" marginheight=\"0\" marginwidth=\"0\" frameborder=\"0\" width=\"100%\" height=\"30\" scrolling=\"no\"></iframe></td>\r\n</tr>\r\n</table>");
                builder.Append("</td>\r\n</tr>\r\n");
                return builder.ToString();
            }
        ...
        private string GetMultPicType(string Alias, string Name, bool IsNotNull, string Content, string Description, int ModelID, int NodeID, DataRow dr)
        {
            ...
            if (ChkThumb && ThumbField != "")
            {
                ...
                if (dr == null)
                {
                    str = str + "<input name=\"txt_" + ThumbField + "\" type=\"text\" class=\"inputtext\" style=\"width: 400px;\" />&nbsp;<input type=\"button\" class=\"button\" onclick=\"SelectThumbFiles('txt_" + ThumbField + "')\" value=\"从已上传文件中选择\"></td>\r\n</tr>";
                }
                else
                {
                    str = str + "<input name=\"txt_" + ThumbField + "\" type=\"text\" class=\"inputtext\" style=\"width: 400px;\" value=\"" + dr["" + ThumbField + ""] + "\" />&nbsp;<input type=\"button\" class=\"button\" onclick=\"SelectThumbFiles('txt_" + ThumbField + "')\" value=\"从已上传文件中选择\"></td>\r\n</tr>";
                }
            }
            string str1 = "";
            str1 = str1 + "<tr class=\"tdbg\">\r\n<td align=\"right\" class=\"tdbgleft\">上传图片</td>\r\n<td>";
            str1 = str1 + "<iframe id=\"Upload_" + Name + "\" src=\"../Common/MultiPicUpload.aspx?ModelID=" + ModelID + "&FieldName=" + Name + "&NodeId=" + NodeID + "\" marginheight=\"0\" marginwidth=\"0\" frameborder=\"0\" width=\"100%\" height=\"165\" scrolling=\"no\"></iframe></td>\r\n</tr>";
            if (IsNotNull)
            {
                str2 = "<font color=\"red\">*</font>";
            }
