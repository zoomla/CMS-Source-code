...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Form','Checkbox','Radio','TextField','Textarea','HiddenField','HiddenField'],
	'/',
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
	['OrderedList','UnorderedList','-','Outdent','Indent'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink','Anchor'],
	['Image','ImageButton','Media','Flash','Table','Rule','Smiley','SpecialChar','Select','Button'],
	'/',
	['Style','FontFormat','FontName','FontSize'],
	['TextColor','BGColor'],
	['FitWindow','-','PageBreak','Vote','About']
] ;
...
FCKConfig.ContextMenu = ['Generic','Link','Anchor','Image','Flash','Select','Textarea','Checkbox','Radio','TextField','HiddenField','Button','BulletedList','NumberedList','Table','Form'] ;
...
FCKConfig.MediaBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Media&Connector=connectors/' + _FileBrowserLanguage + '/connector.' + _FileBrowserExtension ;
...
FCKConfig.LinkUploadAllowedExtensions	= ".(rar|zip|txt|doc|ppt|xls)$" ;			// empty for all
...
FCKConfig.MediaUploadAllowedExtensions	= ".(avi|mpeg|rmvb|rm|wmv|mid|wav|mp3|wma|asf|mp4)$" ;		// empty for all
