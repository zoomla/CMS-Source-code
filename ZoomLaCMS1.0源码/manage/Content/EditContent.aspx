<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeFile="EditContent.aspx.cs" Inherits="ZoomLa.WebSite.Manage.EditContent" %>
...
<body>
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span>&gt;&gt;<span><a href="ContentManage.aspx">内容管理</a></span> &gt;&gt;<span>编辑内容</span>
	</div>
        ...
        <tbody id="Tabs0">
            ...
            <tr class="tdbgbottom">
                <td colspan="2">
                    ...
                    <asp:Button ID="EBtnSubmit" Text="保存项目" OnClick="EBtnSubmit_Click" runat="server" />
                    &nbsp;                
