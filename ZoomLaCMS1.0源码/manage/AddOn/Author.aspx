<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Author.aspx.cs" Inherits="manage_Plus_Author" %>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
        ...
        <tr class="tdbg">
            ...
            <td rowspan="8" colspan="2">
                <table width="100%" border="0" cellpadding="2" cellspacing="1">
                    ...
                    <tr>
                        <td align="left"><asp:TextBox ID="txtpic" runat="server" Width="194px" Height="19px"></asp:TextBox>*<asp:Label
        ...
        <tr class="tdbg">
            <td class="tdbgleft">
                <strong>生日：</strong></td>
            <td>
             <input name="member.birth"  id="tbUBday" runat="server" type="text" value="1982-1-1" size="14" readonly="readonly" onclick="showcalendar(event, this);" onfocus="showcalendar(event, this);if(this.value=='0000-00-00')this.value=''" />(单击文本框,选择年月)  
            </td>
        </tr>
        <tr class="tdbg">
            <td class="tdbgleft">
        ...
        <tr>
            ...
            <asp:Button ID="EBtnModify" Text="修改" OnClick="EBtnModify_Click" runat="server" Visible="false"/>
                ...
                <input name="Cancel" type="button" class="inputbutton" id="Cancel" value="取消" onclick="javascript:window.location.href='AuthorManage.aspx'" />
            </td>
        </tr>
    </table>
    </form>
