<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddWork.aspx.cs" Inherits="manage_AddOn_AddWork" %>
...
loadcalendar();
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span>&gt;&gt;<span><a href="WorkManage.aspx">节点管理</a></span> &gt;&gt;<span>
                                    添加节点</span>	</div> 
                                        <div class="clearbox"></div>                     
        <table  style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
        <tr align="center">
            <td colspan="2" class="spacingtitle">
                <asp:Label ID="LblTitleAdd" runat="server" Text="添加节点" Font-Bold="True"></asp:Label>
                <asp:Label ID="LblTitleModify" runat="server" Text="修改节点" Font-Bold="True" Visible="false"></asp:Label></td>
        </tr>
          <tr class="tdbg">
            <td class="tdbgleft" align="right" style="width: 105px">
                <strong>项目名称：&nbsp;</strong></td>
            <td>
                <asp:Label ID="TxtProjectName" runat="server" Text="Label"></asp:Label>
               </td>
        </tr>
        <tr class="tdbg">
            <td class="tdbgleft" align="right" style="width: 105px">
                <strong>节点命名：&nbsp;</strong></td>
            <td>
                <asp:TextBox ID="TxtWorkName" runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="ValrKeywordText" ControlToValidate="TxtWorkName"
                    runat="server" ErrorMessage="项目名称不能为空！" Display="Dynamic"></asp:RequiredFieldValidator></td>
        </tr>
      
        <tr class="tdbg">
            <td class="tdbgleft" align="right" style="width: 105px">
                <strong>节点简述：&nbsp;</strong></td>
            <td>
                <asp:TextBox ID="TxtWorkIntro" runat="server" TextMode="MultiLine" Rows="8" Columns="50"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="TxtWorkIntro"
                    runat="server" ErrorMessage="项目简述不能为空！" Display="Dynamic"></asp:RequiredFieldValidator></td>
        </tr>
       <tr class="tdbg">
            <td class="tdbgleft" align="right" style="width: 105px">
          ...
          <tr class="tdbg">
            ...
            <td class="tdbg" align="left">
                <asp:CheckBoxList ID="cblRoleList" runat="server" BorderStyle="Solid" 
                    DataTextField="RoleName" DataValueField="RoleID"/></td>
        </tr>
        <tr class="tdbgbottom">
            <td colspan="2">
              <asp:Button ID="EBtnModify" Text="修改" OnClick="EBtnModify_Click" runat="server" Visible="false"/><asp:Button ID="EBtnSubmit" Text="保存" OnClick="EBtnSubmit_Click" runat="server" />&nbsp;&nbsp;
      ...
      <tr  class="tdbgbottom"> <td colspan="2"></td>      
         ...
         <tr  class="tdbgbottom"> <td colspan="2"></td>      
         </tr><tr  class="tdbgbottom"> <td colspan="2"></td>      
         </tr>
    </table> <asp:HiddenField ID="HFWid" runat="server" />
    </form>
</body>
</html>
