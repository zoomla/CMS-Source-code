...
public partial class manage_AddOn_DiscussList : System.Web.UI.Page
{
    private B_ProjectDiscuss bpro = new B_ProjectDiscuss();
    private B_ProjectWork bwork = new B_ProjectWork();
    private M_ProjectWork mPwork = new M_ProjectWork();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            {
                this.m_uid = DataConverter.CLng(HttpContext.Current.Request.Cookies["ManageState"]["ManageId"]);
